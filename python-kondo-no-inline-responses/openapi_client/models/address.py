...
class Address(object):
    ...
    def __init__(self, contacts=None, external_ids=None, id=None, latitude=None, longitude=None, tags=None, geofence=None, address_types=None, formatted_address=None, name=None, notes=None, local_vars_configuration=None):  # noqa: E501
