...
class V1DocumentFieldCreate(object):
    ...
    def __init__(self, date_time_value=None, multiple_choice_value=None, number_value=None, string_value=None, value_type=None, local_vars_configuration=None):  # noqa: E501
