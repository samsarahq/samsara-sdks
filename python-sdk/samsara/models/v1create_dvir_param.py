...
class V1createDvirParam(object):
    ...
    def __init__(self, inspection_type=None, mechanic_notes=None, odometer_miles=None, previous_defects_corrected=None, previous_defects_ignored=None, resolved_defect_ids=None, safe=None, trailer_id=None, user_email=None, vehicle_id=None, local_vars_configuration=None):  # noqa: E501
        """V1createDvirParam - a model defined in OpenAPI"""  # noqa: E501
    ...
    def inspection_type(self):
        """Gets the inspection_type of this V1createDvirParam.  # noqa: E501

        Only type 'mechanic' is currently accepted.  # noqa: E501

        :return: The inspection_type of this V1createDvirParam.  # noqa: E501
        :rtype: str
        """
    ...
    def inspection_type(self, inspection_type):
        """Sets the inspection_type of this V1createDvirParam.

        Only type 'mechanic' is currently accepted.  # noqa: E501

        :param inspection_type: The inspection_type of this V1createDvirParam.  # noqa: E501
        :type: str
        """
    ...
    def mechanic_notes(self):
        """Gets the mechanic_notes of this V1createDvirParam.  # noqa: E501

        Any notes from the mechanic.  # noqa: E501

        :return: The mechanic_notes of this V1createDvirParam.  # noqa: E501
        :rtype: str
        """
    ...
    def mechanic_notes(self, mechanic_notes):
        """Sets the mechanic_notes of this V1createDvirParam.

        Any notes from the mechanic.  # noqa: E501

        :param mechanic_notes: The mechanic_notes of this V1createDvirParam.  # noqa: E501
        :type: str
        """
    ...
    def odometer_miles(self):
        """Gets the odometer_miles of this V1createDvirParam.  # noqa: E501

        The current odometer of the vehicle.  # noqa: E501

        :return: The odometer_miles of this V1createDvirParam.  # noqa: E501
        :rtype: int
        """
    ...
    def odometer_miles(self, odometer_miles):
        """Sets the odometer_miles of this V1createDvirParam.

        The current odometer of the vehicle.  # noqa: E501

        :param odometer_miles: The odometer_miles of this V1createDvirParam.  # noqa: E501
        :type: int
        """
    ...
    def previous_defects_corrected(self):
        """Gets the previous_defects_corrected of this V1createDvirParam.  # noqa: E501
        ...
        :return: The previous_defects_corrected of this V1createDvirParam.  # noqa: E501
        :rtype: bool
        """
    ...
    def previous_defects_corrected(self, previous_defects_corrected):
        """Sets the previous_defects_corrected of this V1createDvirParam.

        Whether any previous defects were corrected. If this vehicle or trailer was previously marked unsafe, and this DVIR marks it as safe, either previousDefectsCorrected or previousDefectsIgnored must be true.  # noqa: E501

        :param previous_defects_corrected: The previous_defects_corrected of this V1createDvirParam.  # noqa: E501
        :type: bool
        """
    ...
    def previous_defects_ignored(self):
        """Gets the previous_defects_ignored of this V1createDvirParam.  # noqa: E501
        ...
        :return: The previous_defects_ignored of this V1createDvirParam.  # noqa: E501
        :rtype: bool
        """
    ...
    def previous_defects_ignored(self, previous_defects_ignored):
        """Sets the previous_defects_ignored of this V1createDvirParam.

        Whether any previous defects were ignored. If this vehicle or trailer was previously marked unsafe, and this DVIR marks it as safe, either previousDefectsCorrected or previousDefectsIgnored must be true.  # noqa: E501

        :param previous_defects_ignored: The previous_defects_ignored of this V1createDvirParam.  # noqa: E501
        :type: bool
        """
    ...
    def resolved_defect_ids(self):
        """Gets the resolved_defect_ids of this V1createDvirParam.  # noqa: E501

        List of defect IDs to resolve.  The defects must be associated with the provided vehicle or trailer.  # noqa: E501

        :return: The resolved_defect_ids of this V1createDvirParam.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def resolved_defect_ids(self, resolved_defect_ids):
        """Sets the resolved_defect_ids of this V1createDvirParam.

        List of defect IDs to resolve.  The defects must be associated with the provided vehicle or trailer.  # noqa: E501

        :param resolved_defect_ids: The resolved_defect_ids of this V1createDvirParam.  # noqa: E501
        :type: list[int]
        """
    ...
    @property
    def safe(self):
        """Gets the safe of this V1createDvirParam.  # noqa: E501

        Whether or not this vehicle or trailer is safe to drive.  # noqa: E501

        :return: The safe of this V1createDvirParam.  # noqa: E501
        :rtype: str
        """
        return self._safe
    ...
    @safe.setter
    def safe(self, safe):
        """Sets the safe of this V1createDvirParam.

        Whether or not this vehicle or trailer is safe to drive.  # noqa: E501

        :param safe: The safe of this V1createDvirParam.  # noqa: E501
        :type: str
        """
    ...
    @property
    def trailer_id(self):
        """Gets the trailer_id of this V1createDvirParam.  # noqa: E501

        Id of trailer being inspected. Either vehicleId or trailerId must be provided.  # noqa: E501

        :return: The trailer_id of this V1createDvirParam.  # noqa: E501
        :rtype: int
        """
    ...
    def trailer_id(self, trailer_id):
        """Sets the trailer_id of this V1createDvirParam.

        Id of trailer being inspected. Either vehicleId or trailerId must be provided.  # noqa: E501

        :param trailer_id: The trailer_id of this V1createDvirParam.  # noqa: E501
        :type: int
        """
    ...
    def user_email(self, user_email):
        """Sets the user_email of this V1createDvirParam.

        The Samsara login email for the person creating the DVIR. The email must correspond to a Samsara user's email.  # noqa: E501

        :param user_email: The user_email of this V1createDvirParam.  # noqa: E501
        :type: str
        """
    ...
    @property
    def vehicle_id(self):
        """Gets the vehicle_id of this V1createDvirParam.  # noqa: E501

        Id of vehicle being inspected. Either vehicleId or trailerId must be provided.  # noqa: E501

        :return: The vehicle_id of this V1createDvirParam.  # noqa: E501
        :rtype: int
        """
    ...
    def vehicle_id(self, vehicle_id):
        """Sets the vehicle_id of this V1createDvirParam.

        Id of vehicle being inspected. Either vehicleId or trailerId must be provided.  # noqa: E501

        :param vehicle_id: The vehicle_id of this V1createDvirParam.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1createDvirParam):
            return False
