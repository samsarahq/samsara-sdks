...
class V1Document(object):
    ...
    def driver_created_at_ms(self):
        ...
        The time in Unix epoch milliseconds that the document was created in the driver app.  # noqa: E501
    ...
    def org_id(self):
        ...
        Organization ID that the document belongs to.  # noqa: E501
    ...
    def server_created_at_ms(self):
        ...
        The time in Unix epoch milliseconds that the document was received by the server.  # noqa: E501
    ...
    def server_updated_at_ms(self):
        ...
        The time in Unix epoch milliseconds that the document was updated on the server.  # noqa: E501
    ...
    def vehicle_id(self):
        ...
        ID of the vehicle the driver was signed into when the document was submitted. Will be `null` if the document `state` is `Required`.  # noqa: E501
