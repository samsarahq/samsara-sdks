...
class DriverCreate(object):
    ...
    def __init__(self, carrier_settings=None, current_vehicle_id=None, eld_adverse_weather_exemption_enabled=False, eld_big_day_exemption_enabled=False, eld_day_start_hour=None, eld_exempt=False, eld_exempt_reason=None, eld_pc_enabled=False, eld_ym_enabled=False, external_ids=None, license_number=None, license_state=None, locale=None, name=None, notes=None, password=None, phone=None, static_assigned_vehicle_id=None, tag_ids=None, timezone=None, username=None, vehicle_group_tag_id=None, local_vars_configuration=None):  # noqa: E501
        """DriverCreate - a model defined in OpenAPI"""  # noqa: E501
