...
class ContactsApi(object):
    ...
    def create_contact(self, contact, **kwargs):  # noqa: E501
        ...
        :param ContactInput contact: Add a contact. (required)
    ...
    def get_contacts_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] > 512:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_contacts`, must be a value less than or equal to `512`")  # noqa: E501
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_contacts`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def update_contact_by_id(self, id, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str id: Unique identifier for the contact. (required)
        :param ContactInput contact: Updates to the contact.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
