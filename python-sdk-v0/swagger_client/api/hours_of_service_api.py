...
class HoursOfServiceApi(object):
    ...
    def v1get_fleet_drivers_hos_daily_logs(self, driver_id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.v1get_fleet_drivers_hos_daily_logs_with_http_info(driver_id, **kwargs)  # noqa: E501
            return data
    ...
    def v1get_fleet_drivers_hos_daily_logs_with_http_info(self, driver_id, **kwargs):  # noqa: E501
        ...
        if ('driver_id' not in params or
            ...
            raise ValueError("Missing the required parameter `driver_id` when calling `v1get_fleet_drivers_hos_daily_logs`")  # noqa: E501
    ...
    def v1get_fleet_hos_authentication_logs(self, driver_id, start_ms, end_ms, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.v1get_fleet_hos_authentication_logs_with_http_info(driver_id, start_ms, end_ms, **kwargs)  # noqa: E501
            return data
    ...
    def v1get_fleet_hos_authentication_logs_with_http_info(self, driver_id, start_ms, end_ms, **kwargs):  # noqa: E501
        ...
        if ('driver_id' not in params or
                params['driver_id'] is None):
            raise ValueError("Missing the required parameter `driver_id` when calling `v1get_fleet_hos_authentication_logs`")  # noqa: E501
        # verify the required parameter 'start_ms' is set
        if ('start_ms' not in params or
                params['start_ms'] is None):
            raise ValueError("Missing the required parameter `start_ms` when calling `v1get_fleet_hos_authentication_logs`")  # noqa: E501
        # verify the required parameter 'end_ms' is set
        if ('end_ms' not in params or
                params['end_ms'] is None):
            raise ValueError("Missing the required parameter `end_ms` when calling `v1get_fleet_hos_authentication_logs`")  # noqa: E501
        ...
        query_params = []
        if 'driver_id' in params:
            query_params.append(('driverId', params['driver_id']))  # noqa: E501
    ...
    def v1get_fleet_hos_logs(self, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1get_fleet_hos_logs(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.v1get_fleet_hos_logs_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.v1get_fleet_hos_logs_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def v1get_fleet_hos_logs_with_http_info(self, body, **kwargs):  # noqa: E501
        """Get HOS logs for a specific driver  # noqa: E501

        <n class=\"warning\"> <nh> <i class=\"fa fa-exclamation-circle\"></i> This endpoint is still on our legacy API. </nh> </n>  Get the HOS (hours of service) logs for the specified driver. This method returns all the HOS statuses that the driver was in during this time period.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1get_fleet_hos_logs_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `v1get_fleet_hos_logs`")  # noqa: E501
    ...
    def v1get_fleet_hos_logs_summary(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.v1get_fleet_hos_logs_summary_with_http_info(**kwargs)  # noqa: E501
            return data
