...
class MaintenanceApi(object):
    ...
    def v1create_dvir(self, body, **kwargs):  # noqa: E501
        ...
        >>> thread = api.v1create_dvir(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param object body: DVIR creation body (required)
        :return: V1DvirBase
        ...
        if kwargs.get('async_req'):
            return self.v1create_dvir_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.v1create_dvir_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def v1create_dvir_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create a DVIR  # noqa: E501

        <n class=\"warning\"> <nh> <i class=\"fa fa-exclamation-circle\"></i> This endpoint is still on our legacy API. </nh> </n>  Create a new dvir, marking a vehicle or trailer safe or unsafe.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1create_dvir_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `v1create_dvir`")  # noqa: E501
    ...
    def v1get_dvirs(self, end_ms, duration_ms, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.v1get_dvirs_with_http_info(end_ms, duration_ms, **kwargs)  # noqa: E501
            return data
    ...
    def v1get_dvirs_with_http_info(self, end_ms, duration_ms, **kwargs):  # noqa: E501
        ...
        if ('end_ms' not in params or
            ...
            raise ValueError("Missing the required parameter `end_ms` when calling `v1get_dvirs`")  # noqa: E501
        # verify the required parameter 'duration_ms' is set
        if ('duration_ms' not in params or
                params['duration_ms'] is None):
            raise ValueError("Missing the required parameter `duration_ms` when calling `v1get_dvirs`")  # noqa: E501
    ...
    def v1get_fleet_maintenance_list(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.v1get_fleet_maintenance_list_with_http_info(**kwargs)  # noqa: E501
            return data
