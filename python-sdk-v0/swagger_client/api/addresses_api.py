...
class AddressesApi(object):
    ...
    def create_address(self, **kwargs):  # noqa: E501
        ...
        :param AddressCreate body: The address to create.
        :return: object
    ...
    def delete_address_by_id(self, id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str id: Unique Samsara ID for the address (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.delete_address_by_id_with_http_info(id, **kwargs)  # noqa: E501
            return data
    ...
    def delete_address_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `delete_address_by_id`")  # noqa: E501
    ...
    def get_address_by_id(self, id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_address_by_id_with_http_info(id, **kwargs)  # noqa: E501
            return data
    ...
    def get_address_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_address_by_id`")  # noqa: E501
    ...
    def get_addresses(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_addresses_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def update_address_by_id(self, id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str id: Unique Samsara ID for the address (required)
        :param AddressPatch body: The address fields to update.
        :return: object
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.update_address_by_id_with_http_info(id, **kwargs)  # noqa: E501
            return data
    ...
    def update_address_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `update_address_by_id`")  # noqa: E501
