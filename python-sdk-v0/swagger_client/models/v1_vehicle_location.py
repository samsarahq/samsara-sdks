...
class V1VehicleLocation(object):
    ...
    def __init__(self, driver_id=None, heading=None, id=None, latitude=None, location=None, longitude=None, name=None, odometer_meters=None, odometer_type=None, on_trip=None, route_ids=None, speed=None, time=None, vin=None):  # noqa: E501
        """V1VehicleLocation - a model defined in Swagger"""  # noqa: E501
    ...
    def odometer_type(self, odometer_type):
        ...
        if odometer_type not in allowed_values:
            raise ValueError(
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1VehicleLocation, dict):
