...
class V1DvirDefectBase(object):
    ...
    def __init__(self, comment=None, defect_type=None, id=None, resolved=None, resolved_at=None, resolved_by_driver_id=None, resolved_by_mechanic_id=None):  # noqa: E501
        """V1DvirDefectBase - a model defined in Swagger"""  # noqa: E501
        self._comment = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1DvirDefectBase, dict):
