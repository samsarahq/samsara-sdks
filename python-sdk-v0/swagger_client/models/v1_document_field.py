...
class V1DocumentField(object):
    ...
    swagger_types = {
        'date_time_value': 'str',
        'multiple_choice_value': 'list[object]',
        'number_value': 'float',
        'photo_value': 'list[object]',
        'string_value': 'str',
        'value_type': 'str'
    }
    ...
    def __init__(self, date_time_value=None, multiple_choice_value=None, number_value=None, photo_value=None, string_value=None, value_type=None):  # noqa: E501
        """V1DocumentField - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1DocumentField, dict):
