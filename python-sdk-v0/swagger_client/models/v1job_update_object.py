...
class V1jobUpdateObject(object):
    ...
    swagger_types = {
        ...
        'prev_job_state': 'V1prevJobStatus',
    ...
    def __init__(self, changed_at_ms=None, job_id=None, job_state=None, prev_job_state=None, route=None, route_id=None):  # noqa: E501
        """V1jobUpdateObject - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1jobUpdateObject, dict):
