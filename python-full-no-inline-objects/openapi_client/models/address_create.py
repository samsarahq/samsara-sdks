...
class AddressCreate(object):
    ...
    def __init__(self, contact_ids=None, latitude=None, longitude=None, tag_ids=None, geofence=None, address_types=None, formatted_address=None, name=None, notes=None, local_vars_configuration=None):  # noqa: E501
