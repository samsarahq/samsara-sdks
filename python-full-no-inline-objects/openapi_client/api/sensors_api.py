...
class SensorsApi(object):
    ...
    def v1get_sensors(self, **kwargs):  # noqa: E501
        ...
        :param InlineObject9 v1group_id_body_param:
    ...
    def v1get_sensors_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(V1getSensorsResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        all_params = ['v1group_id_body_param']  # noqa: E501
        ...
        body_params = None
        if 'v1group_id_body_param' in local_var_params:
            body_params = local_var_params['v1group_id_body_param']
        # HTTP header `Accept`
        ...
        return self.api_client.call_api(
            ...
            response_type='V1getSensorsResponse',  # noqa: E501
    ...
    def v1get_sensors_temperature(self, v1sensor_param, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param InlineObject10 v1sensor_param: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
