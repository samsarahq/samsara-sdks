...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of samsara_test.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = samsara_test.Configuration(
    ...
    Note you can use the constants defined in the samsara_test.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = samsara_test.Configuration(
        signing_info = samsara_test.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="https://api.samsara.com",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("samsara_test")
