...
class AddressCreate(object):
    ...
    def __init__(self, contact_ids=None, external_ids=None, tag_ids=None, latitude=None, longitude=None, geofence=None, formatted_address=None, name=None, notes=None, address_types=None, local_vars_configuration=None):  # noqa: E501
        """AddressCreate - a model defined in OpenAPI"""  # noqa: E501
    ...
    def contact_ids(self):
        """Gets the contact_ids of this AddressCreate.  # noqa: E501

        An array of IDs of contacts to associate with this address.  # noqa: E501

        :return: The contact_ids of this AddressCreate.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def contact_ids(self, contact_ids):
        """Sets the contact_ids of this AddressCreate.

        An array of IDs of contacts to associate with this address.  # noqa: E501

        :param contact_ids: The contact_ids of this AddressCreate.  # noqa: E501
        :type: list[str]
        """
    ...
    def external_ids(self):
        """Gets the external_ids of this AddressCreate.  # noqa: E501
        ...
        :return: The external_ids of this AddressCreate.  # noqa: E501
        :rtype: dict(str, str)
        """
    ...
    def external_ids(self, external_ids):
        """Sets the external_ids of this AddressCreate.

        User-defined dictionary of external IDs (key-value pairs). Both the keys and the values of the dictionary are of type string and must be alphanumeric. Each organization can have at most 10 unique external ID keys. To delete an external ID, set its value to null or the empty string (`\"\"`). An external ID can be used as a path parameter to retrieve or update that resource.  # noqa: E501

        :param external_ids: The external_ids of this AddressCreate.  # noqa: E501
        :type: dict(str, str)
        """
    ...
    @property
    def tag_ids(self):
        """Gets the tag_ids of this AddressCreate.  # noqa: E501

        An array of IDs of tags to associate with this address.  # noqa: E501

        :return: The tag_ids of this AddressCreate.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def tag_ids(self, tag_ids):
        """Sets the tag_ids of this AddressCreate.

        An array of IDs of tags to associate with this address.  # noqa: E501

        :param tag_ids: The tag_ids of this AddressCreate.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def latitude(self):
        """Gets the latitude of this AddressCreate.  # noqa: E501

        Optional latitude field to override the geocoded latitude from the formatted address.  # noqa: E501

        :return: The latitude of this AddressCreate.  # noqa: E501
        :rtype: float
        """
    ...
    def latitude(self, latitude):
        """Sets the latitude of this AddressCreate.

        Optional latitude field to override the geocoded latitude from the formatted address.  # noqa: E501

        :param latitude: The latitude of this AddressCreate.  # noqa: E501
        :type: float
        """
    ...
    @property
    def longitude(self):
        """Gets the longitude of this AddressCreate.  # noqa: E501

        Optional longitude field to override the geocoded longitude from the formatted address.  # noqa: E501

        :return: The longitude of this AddressCreate.  # noqa: E501
        :rtype: float
        """
    ...
    def longitude(self, longitude):
        """Sets the longitude of this AddressCreate.

        Optional longitude field to override the geocoded longitude from the formatted address.  # noqa: E501

        :param longitude: The longitude of this AddressCreate.  # noqa: E501
        :type: float
        """
    ...
    @property
    def geofence(self):
        """Gets the geofence of this AddressCreate.  # noqa: E501


        :return: The geofence of this AddressCreate.  # noqa: E501
    ...
    def geofence(self, geofence):
        """Sets the geofence of this AddressCreate.


        :param geofence: The geofence of this AddressCreate.  # noqa: E501
