...
// VehicleObdOdometerMeters struct for VehicleObdOdometerMeters
type VehicleObdOdometerMeters struct {
	// UTC timestamp in RFC 3339 milliseconds format.
	Time *string `json:"time,omitempty"`
	// Number of meters the vehicle has traveled according to the on-board diagnostics, as read by the vehicle gateway.
...
type NullableVehicleObdOdometerMeters struct {
	Value        VehicleObdOdometerMeters
	ExplicitNull bool
}

func (v NullableVehicleObdOdometerMeters) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableVehicleObdOdometerMeters) UnmarshalJSON(src []byte) error {
