...
// ContactInput Information for adding a notification contact for alerts.
...
type NullableContactInput struct {
	Value        ContactInput
	ExplicitNull bool
}

func (v NullableContactInput) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableContactInput) UnmarshalJSON(src []byte) error {
