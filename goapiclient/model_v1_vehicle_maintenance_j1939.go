...
// V1VehicleMaintenanceJ1939 J1939 based data. Null if no data is available.
type V1VehicleMaintenanceJ1939 struct {
	CheckEngineLight *V1VehicleMaintenanceJ1939CheckEngineLight `json:"checkEngineLight,omitempty"`
	// J1939 DTCs.
	DiagnosticTroubleCodes *[]V1VehicleMaintenanceJ1939DiagnosticTroubleCodes `json:"diagnosticTroubleCodes,omitempty"`
}
...
func (o *V1VehicleMaintenanceJ1939) GetCheckEngineLight() V1VehicleMaintenanceJ1939CheckEngineLight {
	if o == nil || o.CheckEngineLight == nil {
		var ret V1VehicleMaintenanceJ1939CheckEngineLight
		return ret
	}
...
func (o *V1VehicleMaintenanceJ1939) GetDiagnosticTroubleCodes() []V1VehicleMaintenanceJ1939DiagnosticTroubleCodes {
	if o == nil || o.DiagnosticTroubleCodes == nil {
		var ret []V1VehicleMaintenanceJ1939DiagnosticTroubleCodes
		return ret
	}
...
type NullableV1VehicleMaintenanceJ1939 struct {
	Value        V1VehicleMaintenanceJ1939
	ExplicitNull bool
}

func (v NullableV1VehicleMaintenanceJ1939) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1VehicleMaintenanceJ1939) UnmarshalJSON(src []byte) error {
