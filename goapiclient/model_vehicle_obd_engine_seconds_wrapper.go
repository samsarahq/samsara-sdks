...
// VehicleObdEngineSecondsWrapper struct for VehicleObdEngineSecondsWrapper
type VehicleObdEngineSecondsWrapper struct {
...
type NullableVehicleObdEngineSecondsWrapper struct {
	Value        VehicleObdEngineSecondsWrapper
	ExplicitNull bool
}

func (v NullableVehicleObdEngineSecondsWrapper) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableVehicleObdEngineSecondsWrapper) UnmarshalJSON(src []byte) error {
