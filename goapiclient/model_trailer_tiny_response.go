...
// TrailerTinyResponse A minified trailer object.
type TrailerTinyResponse struct {
	// ID of the trailer.
...
type NullableTrailerTinyResponse struct {
	Value        TrailerTinyResponse
	ExplicitNull bool
}

func (v NullableTrailerTinyResponse) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableTrailerTinyResponse) UnmarshalJSON(src []byte) error {
