...
// VehicleCtpSmogTestDataWrapper struct for VehicleCtpSmogTestDataWrapper
type VehicleCtpSmogTestDataWrapper struct {
	CtpSmogTestData *[]VehicleCtpSmogTestData `json:"ctpSmogTestData,omitempty"`
}
...
func (o *VehicleCtpSmogTestDataWrapper) GetCtpSmogTestData() []VehicleCtpSmogTestData {
	if o == nil || o.CtpSmogTestData == nil {
		var ret []VehicleCtpSmogTestData
		return ret
	}
...
type NullableVehicleCtpSmogTestDataWrapper struct {
	Value        VehicleCtpSmogTestDataWrapper
	ExplicitNull bool
}

func (v NullableVehicleCtpSmogTestDataWrapper) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableVehicleCtpSmogTestDataWrapper) UnmarshalJSON(src []byte) error {
