...
// ListDataInputsResponse struct for ListDataInputsResponse
type ListDataInputsResponse struct {
...
type NullableListDataInputsResponse struct {
	Value        ListDataInputsResponse
	ExplicitNull bool
}

func (v NullableListDataInputsResponse) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableListDataInputsResponse) UnmarshalJSON(src []byte) error {
