...
// V1DispatchRouteAllOf struct for V1DispatchRouteAllOf
type V1DispatchRouteAllOf struct {
...
type NullableV1DispatchRouteAllOf struct {
	Value        V1DispatchRouteAllOf
	ExplicitNull bool
}

func (v NullableV1DispatchRouteAllOf) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1DispatchRouteAllOf) UnmarshalJSON(src []byte) error {
