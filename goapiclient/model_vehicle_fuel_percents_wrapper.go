...
// VehicleFuelPercentsWrapper struct for VehicleFuelPercentsWrapper
type VehicleFuelPercentsWrapper struct {
...
type NullableVehicleFuelPercentsWrapper struct {
	Value        VehicleFuelPercentsWrapper
	ExplicitNull bool
}

func (v NullableVehicleFuelPercentsWrapper) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableVehicleFuelPercentsWrapper) UnmarshalJSON(src []byte) error {
