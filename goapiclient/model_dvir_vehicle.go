...
// DvirVehicle struct for DvirVehicle
type DvirVehicle struct {
	// ID of the vehicle.
...
type NullableDvirVehicle struct {
	Value        DvirVehicle
	ExplicitNull bool
}

func (v NullableDvirVehicle) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableDvirVehicle) UnmarshalJSON(src []byte) error {
