...
// V1DocumentCreateBase struct for V1DocumentCreateBase
type V1DocumentCreateBase struct {
...
type NullableV1DocumentCreateBase struct {
	Value        V1DocumentCreateBase
	ExplicitNull bool
}

func (v NullableV1DocumentCreateBase) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1DocumentCreateBase) UnmarshalJSON(src []byte) error {
