...
// V1FleetVehicleLocation Contains the location and speed of a vehicle at a particular time
type V1FleetVehicleLocation struct {
...
type NullableV1FleetVehicleLocation struct {
	Value        V1FleetVehicleLocation
	ExplicitNull bool
}

func (v NullableV1FleetVehicleLocation) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1FleetVehicleLocation) UnmarshalJSON(src []byte) error {
