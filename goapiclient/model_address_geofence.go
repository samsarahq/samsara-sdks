...
// GetCircleOk returns a tuple with the Circle field value if set, zero value otherwise
...
// GetPolygonOk returns a tuple with the Polygon field value if set, zero value otherwise
// and a boolean to check if the value has been set.
