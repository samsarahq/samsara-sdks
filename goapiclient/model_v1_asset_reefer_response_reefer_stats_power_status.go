...
// V1AssetReeferResponseReeferStatsPowerStatus struct for V1AssetReeferResponseReeferStatsPowerStatus
type V1AssetReeferResponseReeferStatsPowerStatus struct {
...
type NullableV1AssetReeferResponseReeferStatsPowerStatus struct {
	Value        V1AssetReeferResponseReeferStatsPowerStatus
	ExplicitNull bool
}

func (v NullableV1AssetReeferResponseReeferStatsPowerStatus) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1AssetReeferResponseReeferStatsPowerStatus) UnmarshalJSON(src []byte) error {
