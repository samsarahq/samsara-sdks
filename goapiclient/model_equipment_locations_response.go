...
// EquipmentLocationsResponse List of equipment locations for the specified time period.
type EquipmentLocationsResponse struct {
	// ID of the equipment.
	Id string `json:"id"`
...
type NullableEquipmentLocationsResponse struct {
	Value        EquipmentLocationsResponse
	ExplicitNull bool
}

func (v NullableEquipmentLocationsResponse) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableEquipmentLocationsResponse) UnmarshalJSON(src []byte) error {
