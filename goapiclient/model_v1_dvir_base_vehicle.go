...
// V1DvirBaseVehicle The vehicle on which DVIR was done.
type V1DvirBaseVehicle struct {
...
type NullableV1DvirBaseVehicle struct {
	Value        V1DvirBaseVehicle
	ExplicitNull bool
}

func (v NullableV1DvirBaseVehicle) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1DvirBaseVehicle) UnmarshalJSON(src []byte) error {
