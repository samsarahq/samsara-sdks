...
// V1TripResponseStartAddress Text representation of nearest identifiable location to the start (latitude, longitude) coordinates.
type V1TripResponseStartAddress struct {
...
type NullableV1TripResponseStartAddress struct {
	Value        V1TripResponseStartAddress
	ExplicitNull bool
}

func (v NullableV1TripResponseStartAddress) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1TripResponseStartAddress) UnmarshalJSON(src []byte) error {
