...
// EquipmentGpsOdometerMeters Stat point for the odometer of the engine in meters based on readings from the Samsara Gateway GPS data.
type EquipmentGpsOdometerMeters struct {
...
type NullableEquipmentGpsOdometerMeters struct {
	Value        EquipmentGpsOdometerMeters
	ExplicitNull bool
}

func (v NullableEquipmentGpsOdometerMeters) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableEquipmentGpsOdometerMeters) UnmarshalJSON(src []byte) error {
