...
// V1allRouteJobUpdates struct for V1allRouteJobUpdates
type V1allRouteJobUpdates struct {
	JobUpdates *[]V1jobUpdateObject `json:"job_updates,omitempty"`
	// Sequence ID of the last update returned in the response
	SequenceId *string `json:"sequence_id,omitempty"`
}

// GetJobUpdates returns the JobUpdates field value if set, zero value otherwise.
func (o *V1allRouteJobUpdates) GetJobUpdates() []V1jobUpdateObject {
	if o == nil || o.JobUpdates == nil {
		var ret []V1jobUpdateObject
		return ret
	}
	return *o.JobUpdates
}

// GetJobUpdatesOk returns a tuple with the JobUpdates field value if set, zero value otherwise
...
// GetSequenceIdOk returns a tuple with the SequenceId field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
type NullableV1allRouteJobUpdates struct {
	Value        V1allRouteJobUpdates
	ExplicitNull bool
}

func (v NullableV1allRouteJobUpdates) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1allRouteJobUpdates) UnmarshalJSON(src []byte) error {
