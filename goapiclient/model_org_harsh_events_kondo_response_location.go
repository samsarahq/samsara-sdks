...
// OrgHarshEventsKondoResponseLocation struct for OrgHarshEventsKondoResponseLocation
type OrgHarshEventsKondoResponseLocation struct {
	// Longitude at which the harsh event happened
...
type NullableOrgHarshEventsKondoResponseLocation struct {
	Value        OrgHarshEventsKondoResponseLocation
	ExplicitNull bool
}

func (v NullableOrgHarshEventsKondoResponseLocation) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableOrgHarshEventsKondoResponseLocation) UnmarshalJSON(src []byte) error {
