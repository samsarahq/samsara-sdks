...
// VehicleEngineStatesWrapper struct for VehicleEngineStatesWrapper
type VehicleEngineStatesWrapper struct {
...
type NullableVehicleEngineStatesWrapper struct {
	Value        VehicleEngineStatesWrapper
	ExplicitNull bool
}

func (v NullableVehicleEngineStatesWrapper) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableVehicleEngineStatesWrapper) UnmarshalJSON(src []byte) error {
