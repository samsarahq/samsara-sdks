...
// EquipmentEngineSeconds Stat point for the on time of the engine.
type EquipmentEngineSeconds struct {
...
type NullableEquipmentEngineSeconds struct {
	Value        EquipmentEngineSeconds
	ExplicitNull bool
}

func (v NullableEquipmentEngineSeconds) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableEquipmentEngineSeconds) UnmarshalJSON(src []byte) error {
