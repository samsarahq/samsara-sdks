...
// EquipmentObdEngineState Stat point for the state of the engine based on readings of the onboard computer through the J1939 or CAT cable.
type EquipmentObdEngineState struct {
...
type NullableEquipmentObdEngineState struct {
	Value        EquipmentObdEngineState
	ExplicitNull bool
}

func (v NullableEquipmentObdEngineState) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableEquipmentObdEngineState) UnmarshalJSON(src []byte) error {
