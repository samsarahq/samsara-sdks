...
// VehicleObdEngineSeconds struct for VehicleObdEngineSeconds
type VehicleObdEngineSeconds struct {
	// UTC timestamp in RFC 3339 milliseconds format.
	Time *string `json:"time,omitempty"`
	// Number of seconds the vehicle's engine has been on as read by the vehicle gateway.
...
type NullableVehicleObdEngineSeconds struct {
	Value        VehicleObdEngineSeconds
	ExplicitNull bool
}

func (v NullableVehicleObdEngineSeconds) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableVehicleObdEngineSeconds) UnmarshalJSON(src []byte) error {
