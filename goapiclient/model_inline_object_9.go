...
type InlineObject9 struct {
	...
	Series      []V1SensorsHistorySeries `json:"series"`
...
// GetFillMissing returns the FillMissing field value if set, zero value otherwise.
func (o *InlineObject9) GetFillMissing() string {
	if o == nil || o.FillMissing == nil {
		var ret string
		return ret
	}
	return *o.FillMissing
}

// GetFillMissingOk returns a tuple with the FillMissing field value if set, zero value otherwise
...
func (o *InlineObject9) GetSeries() []V1SensorsHistorySeries {
	if o == nil {
		var ret []V1SensorsHistorySeries
		return ret
	}
...
// GetStepMs returns the StepMs field value
