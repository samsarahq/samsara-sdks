...
// V1DispatchRouteUpdate struct for V1DispatchRouteUpdate
type V1DispatchRouteUpdate struct {
...
type NullableV1DispatchRouteUpdate struct {
	Value        V1DispatchRouteUpdate
	ExplicitNull bool
}

func (v NullableV1DispatchRouteUpdate) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1DispatchRouteUpdate) UnmarshalJSON(src []byte) error {
