...
// DataInputSnapshot struct for DataInputSnapshot
type DataInputSnapshot struct {
...
type NullableDataInputSnapshot struct {
	Value        DataInputSnapshot
	ExplicitNull bool
}

func (v NullableDataInputSnapshot) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableDataInputSnapshot) UnmarshalJSON(src []byte) error {
