...
// DriverAllOf struct for DriverAllOf
type DriverAllOf struct {
...
type NullableDriverAllOf struct {
	Value        DriverAllOf
	ExplicitNull bool
}

func (v NullableDriverAllOf) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableDriverAllOf) UnmarshalJSON(src []byte) error {
