...
// VehicleCtpSmogTestData Required data for one CTP smog test.
type VehicleCtpSmogTestData struct {
	...
	RemoteObdTestRecords *[]RemoteObdTestRecords `json:"remoteObdTestRecords,omitempty"`
	// UTC timestamp in RFC 3339 milliseconds format.
	TestDateTime *string `json:"testDateTime,omitempty"`
}
...
type NullableVehicleCtpSmogTestData struct {
	Value        VehicleCtpSmogTestData
	ExplicitNull bool
}

func (v NullableVehicleCtpSmogTestData) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableVehicleCtpSmogTestData) UnmarshalJSON(src []byte) error {
