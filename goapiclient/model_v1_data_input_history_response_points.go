...
// V1DataInputHistoryResponsePoints struct for V1DataInputHistoryResponsePoints
type V1DataInputHistoryResponsePoints struct {
...
type NullableV1DataInputHistoryResponsePoints struct {
	Value        V1DataInputHistoryResponsePoints
	ExplicitNull bool
}

func (v NullableV1DataInputHistoryResponsePoints) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1DataInputHistoryResponsePoints) UnmarshalJSON(src []byte) error {
