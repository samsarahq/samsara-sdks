...
// V1AssetReeferResponseReeferStatsFuelPercentage struct for V1AssetReeferResponseReeferStatsFuelPercentage
type V1AssetReeferResponseReeferStatsFuelPercentage struct {
...
type NullableV1AssetReeferResponseReeferStatsFuelPercentage struct {
	Value        V1AssetReeferResponseReeferStatsFuelPercentage
	ExplicitNull bool
}

func (v NullableV1AssetReeferResponseReeferStatsFuelPercentage) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1AssetReeferResponseReeferStatsFuelPercentage) UnmarshalJSON(src []byte) error {
