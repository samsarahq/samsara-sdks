...
// V1MachineHistoryResponse Contains the results for a machine history request
type V1MachineHistoryResponse struct {
	Machines *[]V1MachineHistoryResponseMachines `json:"machines,omitempty"`
}
...
func (o *V1MachineHistoryResponse) GetMachines() []V1MachineHistoryResponseMachines {
	if o == nil || o.Machines == nil {
		var ret []V1MachineHistoryResponseMachines
		return ret
	}
	return *o.Machines
}
...
type NullableV1MachineHistoryResponse struct {
	Value        V1MachineHistoryResponse
	ExplicitNull bool
}

func (v NullableV1MachineHistoryResponse) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1MachineHistoryResponse) UnmarshalJSON(src []byte) error {
