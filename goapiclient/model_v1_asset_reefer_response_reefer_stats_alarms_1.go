...
// V1AssetReeferResponseReeferStatsAlarms1 struct for V1AssetReeferResponseReeferStatsAlarms1
type V1AssetReeferResponseReeferStatsAlarms1 struct {
	Alarms *[]V1AssetReeferResponseReeferStatsAlarms `json:"alarms,omitempty"`
...
func (o *V1AssetReeferResponseReeferStatsAlarms1) GetAlarms() []V1AssetReeferResponseReeferStatsAlarms {
	if o == nil || o.Alarms == nil {
		var ret []V1AssetReeferResponseReeferStatsAlarms
		return ret
	}
	return *o.Alarms
}
...
type NullableV1AssetReeferResponseReeferStatsAlarms1 struct {
	Value        V1AssetReeferResponseReeferStatsAlarms1
	ExplicitNull bool
}

func (v NullableV1AssetReeferResponseReeferStatsAlarms1) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1AssetReeferResponseReeferStatsAlarms1) UnmarshalJSON(src []byte) error {
