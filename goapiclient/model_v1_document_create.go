...
// V1DocumentCreate struct for V1DocumentCreate
type V1DocumentCreate struct {
	// Universally unique identifier for the document type that this document is being created for.
	DocumentTypeUuid string `json:"documentTypeUuid"`
	// List of fields for the document. The fields must be listed in the order that that they appear in the document type. Only `stringValue`, `numberValue`, `multipleChoiceValue`, and `dateTimeValue` fields are supported for document creation via the API.
...
// GetDocumentTypeUuid returns the DocumentTypeUuid field value
func (o *V1DocumentCreate) GetDocumentTypeUuid() string {
	...
	return o.DocumentTypeUuid
}

// SetDocumentTypeUuid sets field value
func (o *V1DocumentCreate) SetDocumentTypeUuid(v string) {
	o.DocumentTypeUuid = v
}
...
// GetDispatchJobId returns the DispatchJobId field value if set, zero value otherwise.
func (o *V1DocumentCreate) GetDispatchJobId() int64 {
	if o == nil || o.DispatchJobId == nil {
		var ret int64
		return ret
	}
...
// GetDispatchJobIdOk returns a tuple with the DispatchJobId field value if set, zero value otherwise
...
type NullableV1DocumentCreate struct {
	Value        V1DocumentCreate
	ExplicitNull bool
}

func (v NullableV1DocumentCreate) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1DocumentCreate) UnmarshalJSON(src []byte) error {
