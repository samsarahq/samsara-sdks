...
// V1TripResponseStartCoordinates Start (latitude, longitude) in decimal degrees.
type V1TripResponseStartCoordinates struct {
...
type NullableV1TripResponseStartCoordinates struct {
	Value        V1TripResponseStartCoordinates
	ExplicitNull bool
}

func (v NullableV1TripResponseStartCoordinates) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1TripResponseStartCoordinates) UnmarshalJSON(src []byte) error {
