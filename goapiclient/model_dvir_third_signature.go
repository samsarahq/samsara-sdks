...
// DvirThirdSignature struct for DvirThirdSignature
type DvirThirdSignature struct {
...
type NullableDvirThirdSignature struct {
	Value        DvirThirdSignature
	ExplicitNull bool
}

func (v NullableDvirThirdSignature) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableDvirThirdSignature) UnmarshalJSON(src []byte) error {
