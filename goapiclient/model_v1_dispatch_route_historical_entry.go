...
// V1DispatchRouteHistoricalEntry struct for V1DispatchRouteHistoricalEntry
type V1DispatchRouteHistoricalEntry struct {
...
type NullableV1DispatchRouteHistoricalEntry struct {
	Value        V1DispatchRouteHistoricalEntry
	ExplicitNull bool
}

func (v NullableV1DispatchRouteHistoricalEntry) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1DispatchRouteHistoricalEntry) UnmarshalJSON(src []byte) error {
