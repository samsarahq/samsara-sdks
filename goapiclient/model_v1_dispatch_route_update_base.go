...
// V1DispatchRouteUpdateBase struct for V1DispatchRouteUpdateBase
type V1DispatchRouteUpdateBase struct {
...
type NullableV1DispatchRouteUpdateBase struct {
	Value        V1DispatchRouteUpdateBase
	ExplicitNull bool
}

func (v NullableV1DispatchRouteUpdateBase) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1DispatchRouteUpdateBase) UnmarshalJSON(src []byte) error {
