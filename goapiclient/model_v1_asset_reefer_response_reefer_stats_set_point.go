...
// V1AssetReeferResponseReeferStatsSetPoint struct for V1AssetReeferResponseReeferStatsSetPoint
type V1AssetReeferResponseReeferStatsSetPoint struct {
...
type NullableV1AssetReeferResponseReeferStatsSetPoint struct {
	Value        V1AssetReeferResponseReeferStatsSetPoint
	ExplicitNull bool
}

func (v NullableV1AssetReeferResponseReeferStatsSetPoint) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1AssetReeferResponseReeferStatsSetPoint) UnmarshalJSON(src []byte) error {
