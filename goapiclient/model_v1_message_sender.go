...
// V1MessageSender struct for V1MessageSender
type V1MessageSender struct {
...
type NullableV1MessageSender struct {
	Value        V1MessageSender
	ExplicitNull bool
}

func (v NullableV1MessageSender) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1MessageSender) UnmarshalJSON(src []byte) error {
