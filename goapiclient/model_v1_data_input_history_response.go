...
// V1DataInputHistoryResponse struct for V1DataInputHistoryResponse
type V1DataInputHistoryResponse struct {
	// The ID of this data input
	Id *int64 `json:"id,omitempty"`
	// Name of this data input
	Name string `json:"name"`
	// Data points from this data input
	Points *[]V1DataInputHistoryResponsePoints `json:"points,omitempty"`
}
...
func (o *V1DataInputHistoryResponse) GetPoints() []V1DataInputHistoryResponsePoints {
	if o == nil || o.Points == nil {
		var ret []V1DataInputHistoryResponsePoints
		return ret
	}
	return *o.Points
}
...
type NullableV1DataInputHistoryResponse struct {
	Value        V1DataInputHistoryResponse
	ExplicitNull bool
}

func (v NullableV1DataInputHistoryResponse) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1DataInputHistoryResponse) UnmarshalJSON(src []byte) error {
