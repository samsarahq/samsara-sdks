...
// V1DocumentFieldAllOf struct for V1DocumentFieldAllOf
type V1DocumentFieldAllOf struct {
...
type NullableV1DocumentFieldAllOf struct {
	Value        V1DocumentFieldAllOf
	ExplicitNull bool
}

func (v NullableV1DocumentFieldAllOf) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1DocumentFieldAllOf) UnmarshalJSON(src []byte) error {
