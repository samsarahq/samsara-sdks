...
// V1CargoResponse Contains the current cargo status of a sensor.
type V1CargoResponse struct {
	// Deprecated.
	GroupId *int64                    `json:"groupId,omitempty"`
	Sensors *[]V1CargoResponseSensors `json:"sensors,omitempty"`
}
...
func (o *V1CargoResponse) GetSensors() []V1CargoResponseSensors {
	if o == nil || o.Sensors == nil {
		var ret []V1CargoResponseSensors
		return ret
	}
	return *o.Sensors
}
...
type NullableV1CargoResponse struct {
	Value        V1CargoResponse
	ExplicitNull bool
}

func (v NullableV1CargoResponse) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1CargoResponse) UnmarshalJSON(src []byte) error {
