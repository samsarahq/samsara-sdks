...
// DocumentFieldMultipleChoiceMetadata Additional metadata information for a multiple choice field type. Only defined when a field has fieldType: multipleChoice.
type DocumentFieldMultipleChoiceMetadata struct {
	// The options that can be selected.
	Options *[]DocumentFieldMultipleChoiceMetadataOptions `json:"options,omitempty"`
}

// GetOptions returns the Options field value if set, zero value otherwise.
func (o *DocumentFieldMultipleChoiceMetadata) GetOptions() []DocumentFieldMultipleChoiceMetadataOptions {
	if o == nil || o.Options == nil {
		var ret []DocumentFieldMultipleChoiceMetadataOptions
		return ret
	}
	return *o.Options
}
...
type NullableDocumentFieldMultipleChoiceMetadata struct {
	Value        DocumentFieldMultipleChoiceMetadata
	ExplicitNull bool
}

func (v NullableDocumentFieldMultipleChoiceMetadata) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableDocumentFieldMultipleChoiceMetadata) UnmarshalJSON(src []byte) error {
