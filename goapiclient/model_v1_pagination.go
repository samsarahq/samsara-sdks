...
// V1Pagination struct for V1Pagination
...
type NullableV1Pagination struct {
	Value        V1Pagination
	ExplicitNull bool
}

func (v NullableV1Pagination) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1Pagination) UnmarshalJSON(src []byte) error {
