...
// V1AssetsReeferReeferStatsPowerStatus struct for V1AssetsReeferReeferStatsPowerStatus
type V1AssetsReeferReeferStatsPowerStatus struct {
...
type NullableV1AssetsReeferReeferStatsPowerStatus struct {
	Value        V1AssetsReeferReeferStatsPowerStatus
	ExplicitNull bool
}

func (v NullableV1AssetsReeferReeferStatsPowerStatus) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1AssetsReeferReeferStatsPowerStatus) UnmarshalJSON(src []byte) error {
