...
// DvirResponse The DVIR response.
type DvirResponse struct {
...
type NullableDvirResponse struct {
	Value        DvirResponse
	ExplicitNull bool
}

func (v NullableDvirResponse) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableDvirResponse) UnmarshalJSON(src []byte) error {
