...
// V1AssetReeferResponseReeferStatsEngineHours struct for V1AssetReeferResponseReeferStatsEngineHours
type V1AssetReeferResponseReeferStatsEngineHours struct {
...
type NullableV1AssetReeferResponseReeferStatsEngineHours struct {
	Value        V1AssetReeferResponseReeferStatsEngineHours
	ExplicitNull bool
}

func (v NullableV1AssetReeferResponseReeferStatsEngineHours) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1AssetReeferResponseReeferStatsEngineHours) UnmarshalJSON(src []byte) error {
