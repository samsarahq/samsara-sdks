...
// UserRoleInput struct for UserRoleInput
type UserRoleInput struct {
	// The id of the role the user has been granted.
	RoleId string `json:"roleId"`
	// The id of the tag used to grant a role. If no tag is specified, this role applies at the organization level.
...
type NullableUserRoleInput struct {
	Value        UserRoleInput
	ExplicitNull bool
}

func (v NullableUserRoleInput) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableUserRoleInput) UnmarshalJSON(src []byte) error {
