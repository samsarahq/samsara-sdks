...
// DefectResolvedBy The person who resolved this defect.  Will not be returned if the defect is unresolved.
type DefectResolvedBy struct {
...
type NullableDefectResolvedBy struct {
	Value        DefectResolvedBy
	ExplicitNull bool
}

func (v NullableDefectResolvedBy) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableDefectResolvedBy) UnmarshalJSON(src []byte) error {
