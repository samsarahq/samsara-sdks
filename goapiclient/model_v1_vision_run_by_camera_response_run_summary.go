...
// V1VisionRunByCameraResponseRunSummary struct for V1VisionRunByCameraResponseRunSummary
type V1VisionRunByCameraResponseRunSummary struct {
...
type NullableV1VisionRunByCameraResponseRunSummary struct {
	Value        V1VisionRunByCameraResponseRunSummary
	ExplicitNull bool
}

func (v NullableV1VisionRunByCameraResponseRunSummary) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1VisionRunByCameraResponseRunSummary) UnmarshalJSON(src []byte) error {
