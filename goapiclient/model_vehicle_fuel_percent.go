...
// VehicleFuelPercent struct for VehicleFuelPercent
type VehicleFuelPercent struct {
	// UTC timestamp in RFC 3339 milliseconds format.
	Time *string `json:"time,omitempty"`
	// Percent of fuel in the vehicle as read by the vehicle gateway.
...
type NullableVehicleFuelPercent struct {
	Value        VehicleFuelPercent
	ExplicitNull bool
}

func (v NullableVehicleFuelPercent) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableVehicleFuelPercent) UnmarshalJSON(src []byte) error {
