...
type NullableVehicleLocationsResponseData struct {
	Value        VehicleLocationsResponseData
	ExplicitNull bool
}

func (v NullableVehicleLocationsResponseData) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableVehicleLocationsResponseData) UnmarshalJSON(src []byte) error {
