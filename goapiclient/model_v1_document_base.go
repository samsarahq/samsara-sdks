...
// V1DocumentBase struct for V1DocumentBase
type V1DocumentBase struct {
...
type NullableV1DocumentBase struct {
	Value        V1DocumentBase
	ExplicitNull bool
}

func (v NullableV1DocumentBase) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1DocumentBase) UnmarshalJSON(src []byte) error {
