...
// VehicleStatsSnapshotResponse struct for VehicleStatsSnapshotResponse
type VehicleStatsSnapshotResponse struct {
	// ID of the vehicle.
...
type NullableVehicleStatsSnapshotResponse struct {
	Value        VehicleStatsSnapshotResponse
	ExplicitNull bool
}

func (v NullableVehicleStatsSnapshotResponse) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableVehicleStatsSnapshotResponse) UnmarshalJSON(src []byte) error {
