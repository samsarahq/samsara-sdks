...
// EquipmentLocationsResponseAllOf Location point for the equipment.
type EquipmentLocationsResponseAllOf struct {
	Locations *[]EquipmentLocation `json:"locations,omitempty"`
}
...
type NullableEquipmentLocationsResponseAllOf struct {
	Value        EquipmentLocationsResponseAllOf
	ExplicitNull bool
}

func (v NullableEquipmentLocationsResponseAllOf) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableEquipmentLocationsResponseAllOf) UnmarshalJSON(src []byte) error {
