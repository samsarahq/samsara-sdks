...
// EquipmentLocationAllOf struct for EquipmentLocationAllOf
type EquipmentLocationAllOf struct {
...
type NullableEquipmentLocationAllOf struct {
	Value        EquipmentLocationAllOf
	ExplicitNull bool
}

func (v NullableEquipmentLocationAllOf) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableEquipmentLocationAllOf) UnmarshalJSON(src []byte) error {
