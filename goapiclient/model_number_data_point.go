...
type NullableNumberDataPoint struct {
	Value        NumberDataPoint
	ExplicitNull bool
}

func (v NullableNumberDataPoint) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableNumberDataPoint) UnmarshalJSON(src []byte) error {
