...
// V1AssetReeferResponse Reefer-specific asset details
type V1AssetReeferResponse struct {
	// Asset type
	...
	ReeferStats *V1AssetReeferResponseReeferStats `json:"reeferStats,omitempty"`
}
...
// GetAssetTypeOk returns a tuple with the AssetType field value if set, zero value otherwise
...
// GetReeferStats returns the ReeferStats field value if set, zero value otherwise.
func (o *V1AssetReeferResponse) GetReeferStats() V1AssetReeferResponseReeferStats {
	if o == nil || o.ReeferStats == nil {
		var ret V1AssetReeferResponseReeferStats
		return ret
	}
	return *o.ReeferStats
}

// GetReeferStatsOk returns a tuple with the ReeferStats field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
type NullableV1AssetReeferResponse struct {
	Value        V1AssetReeferResponse
	ExplicitNull bool
}

func (v NullableV1AssetReeferResponse) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1AssetReeferResponse) UnmarshalJSON(src []byte) error {
