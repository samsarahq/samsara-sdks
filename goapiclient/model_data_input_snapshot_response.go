...
// DataInputSnapshotResponse struct for DataInputSnapshotResponse
type DataInputSnapshotResponse struct {
	...
	Data       *[]DataInputSnapshot `json:"data,omitempty"`
...
type NullableDataInputSnapshotResponse struct {
	Value        DataInputSnapshotResponse
	ExplicitNull bool
}

func (v NullableDataInputSnapshotResponse) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableDataInputSnapshotResponse) UnmarshalJSON(src []byte) error {
