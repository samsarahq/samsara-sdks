...
// CarrierProposedAssignmentVehicle struct for CarrierProposedAssignmentVehicle
type CarrierProposedAssignmentVehicle struct {
	// ID of the vehicle.
...
type NullableCarrierProposedAssignmentVehicle struct {
	Value        CarrierProposedAssignmentVehicle
	ExplicitNull bool
}

func (v NullableCarrierProposedAssignmentVehicle) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableCarrierProposedAssignmentVehicle) UnmarshalJSON(src []byte) error {
