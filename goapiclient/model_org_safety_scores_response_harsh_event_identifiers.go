...
// OrgSafetyScoresResponseHarshEventIdentifiers struct for OrgSafetyScoresResponseHarshEventIdentifiers
type OrgSafetyScoresResponseHarshEventIdentifiers struct {
	// Event time, specified in RFC 3339
...
// GetEventTimeOk returns a tuple with the EventTime field value if set, zero value otherwise
...
type NullableOrgSafetyScoresResponseHarshEventIdentifiers struct {
	Value        OrgSafetyScoresResponseHarshEventIdentifiers
	ExplicitNull bool
}

func (v NullableOrgSafetyScoresResponseHarshEventIdentifiers) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableOrgSafetyScoresResponseHarshEventIdentifiers) UnmarshalJSON(src []byte) error {
