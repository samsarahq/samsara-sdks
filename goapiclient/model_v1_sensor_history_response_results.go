...
// V1SensorHistoryResponseResults struct for V1SensorHistoryResponseResults
type V1SensorHistoryResponseResults struct {
...
type NullableV1SensorHistoryResponseResults struct {
	Value        V1SensorHistoryResponseResults
	ExplicitNull bool
}

func (v NullableV1SensorHistoryResponseResults) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1SensorHistoryResponseResults) UnmarshalJSON(src []byte) error {
