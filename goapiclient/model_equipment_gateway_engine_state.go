...
// EquipmentGatewayEngineState Stat point for the state of the engine based on readings through the connected aux/digio cable.
type EquipmentGatewayEngineState struct {
...
type NullableEquipmentGatewayEngineState struct {
	Value        EquipmentGatewayEngineState
	ExplicitNull bool
}

func (v NullableEquipmentGatewayEngineState) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableEquipmentGatewayEngineState) UnmarshalJSON(src []byte) error {
