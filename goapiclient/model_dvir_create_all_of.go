...
// DvirCreateAllOf struct for DvirCreateAllOf
type DvirCreateAllOf struct {
...
type NullableDvirCreateAllOf struct {
	Value        DvirCreateAllOf
	ExplicitNull bool
}

func (v NullableDvirCreateAllOf) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableDvirCreateAllOf) UnmarshalJSON(src []byte) error {
