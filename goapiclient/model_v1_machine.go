...
// V1Machine Contains information about a machine.
...
type NullableV1Machine struct {
	Value        V1Machine
	ExplicitNull bool
}

func (v NullableV1Machine) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1Machine) UnmarshalJSON(src []byte) error {
