...
// DocumentCreate The document creation arguments
type DocumentCreate struct {
	// Unique Samsara ID for the document type.
	DocumentTypeId string `json:"documentTypeId"`
	// ID of the driver.
	DriverId string `json:"driverId"`
	// The fields associated with the new document. The fields must be listed in the order that that they appear in the specified document type.
	Fields *[]DocumentCreateFields `json:"fields,omitempty"`
	// Notes
	Notes *string `json:"notes,omitempty"`
	// Unique Samsara ID for the route stop.
	RouteStopId *string `json:"routeStopId,omitempty"`
...
// GetRouteStopId returns the RouteStopId field value if set, zero value otherwise.
func (o *DocumentCreate) GetRouteStopId() string {
	if o == nil || o.RouteStopId == nil {
		var ret string
		return ret
	}
	return *o.RouteStopId
}

// GetRouteStopIdOk returns a tuple with the RouteStopId field value if set, zero value otherwise
// and a boolean to check if the value has been set.
