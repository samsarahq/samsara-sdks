...
type NullableVehicleStatsListResponse struct {
	Value        VehicleStatsListResponse
	ExplicitNull bool
}

func (v NullableVehicleStatsListResponse) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableVehicleStatsListResponse) UnmarshalJSON(src []byte) error {
