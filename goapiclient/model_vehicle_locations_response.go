...
func (o *VehicleLocationsResponse) GetData() []VehicleLocationsResponseData {
	if o == nil {
		var ret []VehicleLocationsResponseData
		return ret
	}
...
type NullableVehicleLocationsResponse struct {
	Value        VehicleLocationsResponse
	ExplicitNull bool
}

func (v NullableVehicleLocationsResponse) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableVehicleLocationsResponse) UnmarshalJSON(src []byte) error {
