...
// EquipmentObdEngineSeconds Stat point for the cumulative on time of the engine based on readings of the onboard computer through the J1939 or CAT cable.
type EquipmentObdEngineSeconds struct {
...
type NullableEquipmentObdEngineSeconds struct {
	Value        EquipmentObdEngineSeconds
	ExplicitNull bool
}

func (v NullableEquipmentObdEngineSeconds) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableEquipmentObdEngineSeconds) UnmarshalJSON(src []byte) error {
