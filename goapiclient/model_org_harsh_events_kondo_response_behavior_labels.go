...
// OrgHarshEventsKondoResponseBehaviorLabels struct for OrgHarshEventsKondoResponseBehaviorLabels
type OrgHarshEventsKondoResponseBehaviorLabels struct {
	// Label source of the harsh event
	LabelSource *string `json:"labelSource,omitempty"`
	// Label type of the harsh event
...
// GetLabelSourceOk returns a tuple with the LabelSource field value if set, zero value otherwise
...
// GetLabelTypeOk returns a tuple with the LabelType field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
type NullableOrgHarshEventsKondoResponseBehaviorLabels struct {
	Value        OrgHarshEventsKondoResponseBehaviorLabels
	ExplicitNull bool
}

func (v NullableOrgHarshEventsKondoResponseBehaviorLabels) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableOrgHarshEventsKondoResponseBehaviorLabels) UnmarshalJSON(src []byte) error {
