...
// UserRoleTinyResponse A minified user role object.
type UserRoleTinyResponse struct {
...
type NullableUserRoleTinyResponse struct {
	Value        UserRoleTinyResponse
	ExplicitNull bool
}

func (v NullableUserRoleTinyResponse) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableUserRoleTinyResponse) UnmarshalJSON(src []byte) error {
