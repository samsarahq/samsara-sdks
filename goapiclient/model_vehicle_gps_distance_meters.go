...
// VehicleGpsDistanceMeters struct for VehicleGpsDistanceMeters
type VehicleGpsDistanceMeters struct {
	// UTC timestamp in RFC 3339 milliseconds format.
	Time *string `json:"time,omitempty"`
	// Number of meters the vehicle has traveled since the gateway was installed.
...
type NullableVehicleGpsDistanceMeters struct {
	Value        VehicleGpsDistanceMeters
	ExplicitNull bool
}

func (v NullableVehicleGpsDistanceMeters) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableVehicleGpsDistanceMeters) UnmarshalJSON(src []byte) error {
