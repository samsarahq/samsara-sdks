...
// V1DispatchRouteHistory struct for V1DispatchRouteHistory
type V1DispatchRouteHistory struct {
	// History of the route's state changes.
	History *[]V1DispatchRouteHistoricalEntry `json:"history,omitempty"`
}

// GetHistory returns the History field value if set, zero value otherwise.
func (o *V1DispatchRouteHistory) GetHistory() []V1DispatchRouteHistoricalEntry {
	if o == nil || o.History == nil {
		var ret []V1DispatchRouteHistoricalEntry
		return ret
	}
	return *o.History
}
...
type NullableV1DispatchRouteHistory struct {
	Value        V1DispatchRouteHistory
	ExplicitNull bool
}

func (v NullableV1DispatchRouteHistory) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1DispatchRouteHistory) UnmarshalJSON(src []byte) error {
