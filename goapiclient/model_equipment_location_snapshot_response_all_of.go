...
// EquipmentLocationSnapshotResponseAllOf struct for EquipmentLocationSnapshotResponseAllOf
type EquipmentLocationSnapshotResponseAllOf struct {
	Location *EquipmentLocation `json:"location,omitempty"`
}

// GetLocation returns the Location field value if set, zero value otherwise.
func (o *EquipmentLocationSnapshotResponseAllOf) GetLocation() EquipmentLocation {
	if o == nil || o.Location == nil {
		var ret EquipmentLocation
		return ret
	}
	return *o.Location
}
...
type NullableEquipmentLocationSnapshotResponseAllOf struct {
	Value        EquipmentLocationSnapshotResponseAllOf
	ExplicitNull bool
}

func (v NullableEquipmentLocationSnapshotResponseAllOf) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableEquipmentLocationSnapshotResponseAllOf) UnmarshalJSON(src []byte) error {
