...
// V1DispatchJobDocumentInfo struct for V1DispatchJobDocumentInfo
type V1DispatchJobDocumentInfo struct {
...
type NullableV1DispatchJobDocumentInfo struct {
	Value        V1DispatchJobDocumentInfo
	ExplicitNull bool
}

func (v NullableV1DispatchJobDocumentInfo) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1DispatchJobDocumentInfo) UnmarshalJSON(src []byte) error {
