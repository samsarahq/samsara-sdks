...
// V1DvirBaseMechanicOrAgentSignature The mechanic's or agent's signature for the DVIR.
type V1DvirBaseMechanicOrAgentSignature struct {
...
// GetMechanicUserId returns the MechanicUserId field value if set, zero value otherwise.
func (o *V1DvirBaseMechanicOrAgentSignature) GetMechanicUserId() int64 {
	if o == nil || o.MechanicUserId == nil {
		var ret int64
		return ret
	}
	return *o.MechanicUserId
}

// GetMechanicUserIdOk returns a tuple with the MechanicUserId field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
type NullableV1DvirBaseMechanicOrAgentSignature struct {
	Value        V1DvirBaseMechanicOrAgentSignature
	ExplicitNull bool
}

func (v NullableV1DvirBaseMechanicOrAgentSignature) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1DvirBaseMechanicOrAgentSignature) UnmarshalJSON(src []byte) error {
