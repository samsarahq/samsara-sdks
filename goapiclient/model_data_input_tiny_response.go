...
// DataInputTinyResponse A minified data input object
type DataInputTinyResponse struct {
...
type NullableDataInputTinyResponse struct {
	Value        DataInputTinyResponse
	ExplicitNull bool
}

func (v NullableDataInputTinyResponse) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableDataInputTinyResponse) UnmarshalJSON(src []byte) error {
