...
// DriverBaseCarrierSettings Carrier for a given driver. If the driver's carrier differs from the general organization's carrier settings, the override value is used. Updating this value only updates the override setting for this driver.
type DriverBaseCarrierSettings struct {
...
type NullableDriverBaseCarrierSettings struct {
	Value        DriverBaseCarrierSettings
	ExplicitNull bool
}

func (v NullableDriverBaseCarrierSettings) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableDriverBaseCarrierSettings) UnmarshalJSON(src []byte) error {
