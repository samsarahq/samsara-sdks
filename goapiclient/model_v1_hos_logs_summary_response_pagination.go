...
// V1HosLogsSummaryResponsePagination struct for V1HosLogsSummaryResponsePagination
type V1HosLogsSummaryResponsePagination struct {
...
type NullableV1HosLogsSummaryResponsePagination struct {
	Value        V1HosLogsSummaryResponsePagination
	ExplicitNull bool
}

func (v NullableV1HosLogsSummaryResponsePagination) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1HosLogsSummaryResponsePagination) UnmarshalJSON(src []byte) error {
