...
// V1HosLogsResponse struct for V1HosLogsResponse
type V1HosLogsResponse struct {
	Logs *[]V1HosLogsResponseLogs `json:"logs,omitempty"`
}

// GetLogs returns the Logs field value if set, zero value otherwise.
func (o *V1HosLogsResponse) GetLogs() []V1HosLogsResponseLogs {
	if o == nil || o.Logs == nil {
		var ret []V1HosLogsResponseLogs
		return ret
	}
	return *o.Logs
}
...
type NullableV1HosLogsResponse struct {
	Value        V1HosLogsResponse
	ExplicitNull bool
}

func (v NullableV1HosLogsResponse) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1HosLogsResponse) UnmarshalJSON(src []byte) error {
