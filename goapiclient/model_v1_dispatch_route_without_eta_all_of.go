...
// V1DispatchRouteWithoutEtaAllOf struct for V1DispatchRouteWithoutEtaAllOf
type V1DispatchRouteWithoutEtaAllOf struct {
...
type NullableV1DispatchRouteWithoutEtaAllOf struct {
	Value        V1DispatchRouteWithoutEtaAllOf
	ExplicitNull bool
}

func (v NullableV1DispatchRouteWithoutEtaAllOf) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1DispatchRouteWithoutEtaAllOf) UnmarshalJSON(src []byte) error {
