...
// V1TrailerAssignmentsResponse struct for V1TrailerAssignmentsResponse
type V1TrailerAssignmentsResponse struct {
	// ID of the trailer
	Id int64 `json:"id"`
...
type NullableV1TrailerAssignmentsResponse struct {
	Value        V1TrailerAssignmentsResponse
	ExplicitNull bool
}

func (v NullableV1TrailerAssignmentsResponse) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1TrailerAssignmentsResponse) UnmarshalJSON(src []byte) error {
