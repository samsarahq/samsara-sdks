...
// V1DoorResponse Contains the current door status of a sensor.
type V1DoorResponse struct {
	// Deprecated.
	GroupId *int64                   `json:"groupId,omitempty"`
	Sensors *[]V1DoorResponseSensors `json:"sensors,omitempty"`
}
...
type NullableV1DoorResponse struct {
	Value        V1DoorResponse
	ExplicitNull bool
}

func (v NullableV1DoorResponse) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1DoorResponse) UnmarshalJSON(src []byte) error {
