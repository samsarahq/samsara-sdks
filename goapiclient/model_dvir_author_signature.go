...
// DvirAuthorSignature struct for DvirAuthorSignature
type DvirAuthorSignature struct {
...
type NullableDvirAuthorSignature struct {
	Value        DvirAuthorSignature
	ExplicitNull bool
}

func (v NullableDvirAuthorSignature) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableDvirAuthorSignature) UnmarshalJSON(src []byte) error {
