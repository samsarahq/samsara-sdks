...
// VehicleGpsOdometerMetersWrapper struct for VehicleGpsOdometerMetersWrapper
type VehicleGpsOdometerMetersWrapper struct {
...
type NullableVehicleGpsOdometerMetersWrapper struct {
	Value        VehicleGpsOdometerMetersWrapper
	ExplicitNull bool
}

func (v NullableVehicleGpsOdometerMetersWrapper) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableVehicleGpsOdometerMetersWrapper) UnmarshalJSON(src []byte) error {
