...
// OrganizationInfoResponse Information about your organization.
type OrganizationInfoResponse struct {
	CarrierSettings *OrganizationInfoResponseCarrierSettings `json:"carrierSettings,omitempty"`
...
func (o *OrganizationInfoResponse) GetCarrierSettings() OrganizationInfoResponseCarrierSettings {
	if o == nil || o.CarrierSettings == nil {
		var ret OrganizationInfoResponseCarrierSettings
		return ret
	}
...
type NullableOrganizationInfoResponse struct {
	Value        OrganizationInfoResponse
	ExplicitNull bool
}

func (v NullableOrganizationInfoResponse) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableOrganizationInfoResponse) UnmarshalJSON(src []byte) error {
