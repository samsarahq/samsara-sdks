...
// V1AssetsReefer Reefer-specific details
type V1AssetsReefer struct {
	// Asset type
	...
	ReeferStats *V1AssetsReeferReeferStats `json:"reeferStats,omitempty"`
}
...
func (o *V1AssetsReefer) GetReeferStats() V1AssetsReeferReeferStats {
	if o == nil || o.ReeferStats == nil {
		var ret V1AssetsReeferReeferStats
		return ret
	}
...
type NullableV1AssetsReefer struct {
	Value        V1AssetsReefer
	ExplicitNull bool
}

func (v NullableV1AssetsReefer) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1AssetsReefer) UnmarshalJSON(src []byte) error {
