...
// VehicleGpsDistanceMetersWrapper struct for VehicleGpsDistanceMetersWrapper
type VehicleGpsDistanceMetersWrapper struct {
...
type NullableVehicleGpsDistanceMetersWrapper struct {
	Value        VehicleGpsDistanceMetersWrapper
	ExplicitNull bool
}

func (v NullableVehicleGpsDistanceMetersWrapper) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableVehicleGpsDistanceMetersWrapper) UnmarshalJSON(src []byte) error {
