...
// V1TemperatureResponse Contains the current temperatures of a sensor.
type V1TemperatureResponse struct {
	// Deprecated.
	GroupId *int64                          `json:"groupId,omitempty"`
	Sensors *[]V1TemperatureResponseSensors `json:"sensors,omitempty"`
}
...
func (o *V1TemperatureResponse) GetSensors() []V1TemperatureResponseSensors {
	if o == nil || o.Sensors == nil {
		var ret []V1TemperatureResponseSensors
		return ret
	}
	return *o.Sensors
}
...
type NullableV1TemperatureResponse struct {
	Value        V1TemperatureResponse
	ExplicitNull bool
}

func (v NullableV1TemperatureResponse) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1TemperatureResponse) UnmarshalJSON(src []byte) error {
