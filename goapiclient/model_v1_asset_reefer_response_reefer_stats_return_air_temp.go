...
// V1AssetReeferResponseReeferStatsReturnAirTemp struct for V1AssetReeferResponseReeferStatsReturnAirTemp
type V1AssetReeferResponseReeferStatsReturnAirTemp struct {
...
type NullableV1AssetReeferResponseReeferStatsReturnAirTemp struct {
	Value        V1AssetReeferResponseReeferStatsReturnAirTemp
	ExplicitNull bool
}

func (v NullableV1AssetReeferResponseReeferStatsReturnAirTemp) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1AssetReeferResponseReeferStatsReturnAirTemp) UnmarshalJSON(src []byte) error {
