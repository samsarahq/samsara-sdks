...
// V1AssetsReeferReeferStatsAmbientAirTemperature struct for V1AssetsReeferReeferStatsAmbientAirTemperature
type V1AssetsReeferReeferStatsAmbientAirTemperature struct {
...
type NullableV1AssetsReeferReeferStatsAmbientAirTemperature struct {
	Value        V1AssetsReeferReeferStatsAmbientAirTemperature
	ExplicitNull bool
}

func (v NullableV1AssetsReeferReeferStatsAmbientAirTemperature) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1AssetsReeferReeferStatsAmbientAirTemperature) UnmarshalJSON(src []byte) error {
