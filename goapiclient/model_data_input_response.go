...
// DataInputResponse struct for DataInputResponse
type DataInputResponse struct {
...
type NullableDataInputResponse struct {
	Value        DataInputResponse
	ExplicitNull bool
}

func (v NullableDataInputResponse) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableDataInputResponse) UnmarshalJSON(src []byte) error {
