...
// CreateCarrierProposedAssignmentRequest New assignment for a driver.
type CreateCarrierProposedAssignmentRequest struct {
...
type NullableCreateCarrierProposedAssignmentRequest struct {
	Value        CreateCarrierProposedAssignmentRequest
	ExplicitNull bool
}

func (v NullableCreateCarrierProposedAssignmentRequest) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableCreateCarrierProposedAssignmentRequest) UnmarshalJSON(src []byte) error {
