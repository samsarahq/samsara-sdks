...
// V1HumidityResponse Contains the current humidity of a sensor.
type V1HumidityResponse struct {
	// Deprecated.
	GroupId *int64                       `json:"groupId,omitempty"`
	Sensors *[]V1HumidityResponseSensors `json:"sensors,omitempty"`
}
...
func (o *V1HumidityResponse) GetSensors() []V1HumidityResponseSensors {
	if o == nil || o.Sensors == nil {
		var ret []V1HumidityResponseSensors
		return ret
	}
	return *o.Sensors
}
...
type NullableV1HumidityResponse struct {
	Value        V1HumidityResponse
	ExplicitNull bool
}

func (v NullableV1HumidityResponse) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1HumidityResponse) UnmarshalJSON(src []byte) error {
