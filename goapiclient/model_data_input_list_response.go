...
// DataInputListResponse struct for DataInputListResponse
type DataInputListResponse struct {
	...
	Data       *[]DataInputResponse `json:"data,omitempty"`
...
type NullableDataInputListResponse struct {
	Value        DataInputListResponse
	ExplicitNull bool
}

func (v NullableDataInputListResponse) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableDataInputListResponse) UnmarshalJSON(src []byte) error {
