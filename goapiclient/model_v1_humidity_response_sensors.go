...
// V1HumidityResponseSensors struct for V1HumidityResponseSensors
type V1HumidityResponseSensors struct {
	...
	HumidityTime *string `json:"humidityTime,omitempty"`
	// ID of the sensor.
...
// GetHumidityOk returns a tuple with the Humidity field value if set, zero value otherwise
...
// GetHumidityTime returns the HumidityTime field value if set, zero value otherwise.
func (o *V1HumidityResponseSensors) GetHumidityTime() string {
	if o == nil || o.HumidityTime == nil {
		var ret string
		return ret
	}
	return *o.HumidityTime
}

// GetHumidityTimeOk returns a tuple with the HumidityTime field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
type NullableV1HumidityResponseSensors struct {
	Value        V1HumidityResponseSensors
	ExplicitNull bool
}

func (v NullableV1HumidityResponseSensors) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1HumidityResponseSensors) UnmarshalJSON(src []byte) error {
