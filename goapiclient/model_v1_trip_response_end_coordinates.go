...
// V1TripResponseEndCoordinates End (latitude, longitude) in decimal degrees.
type V1TripResponseEndCoordinates struct {
...
type NullableV1TripResponseEndCoordinates struct {
	Value        V1TripResponseEndCoordinates
	ExplicitNull bool
}

func (v NullableV1TripResponseEndCoordinates) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1TripResponseEndCoordinates) UnmarshalJSON(src []byte) error {
