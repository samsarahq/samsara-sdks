...
// V1VisionRunByCameraResponseProgram struct for V1VisionRunByCameraResponseProgram
type V1VisionRunByCameraResponseProgram struct {
...
type NullableV1VisionRunByCameraResponseProgram struct {
	Value        V1VisionRunByCameraResponseProgram
	ExplicitNull bool
}

func (v NullableV1VisionRunByCameraResponseProgram) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1VisionRunByCameraResponseProgram) UnmarshalJSON(src []byte) error {
