...
// EquipmentFuelPercent Stat point for the fuel level of the engine as a percentage.
type EquipmentFuelPercent struct {
...
type NullableEquipmentFuelPercent struct {
	Value        EquipmentFuelPercent
	ExplicitNull bool
}

func (v NullableEquipmentFuelPercent) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableEquipmentFuelPercent) UnmarshalJSON(src []byte) error {
