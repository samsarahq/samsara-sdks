...
// TachographActivityListWrapper struct for TachographActivityListWrapper
...
func (o *TachographActivityListWrapper) GetActivity() []TachographActivity {
	if o == nil || o.Activity == nil {
		var ret []TachographActivity
		return ret
	}
	return *o.Activity
}

// GetActivityOk returns a tuple with the Activity field value if set, zero value otherwise
...
type NullableTachographActivityListWrapper struct {
	Value        TachographActivityListWrapper
	ExplicitNull bool
}

func (v NullableTachographActivityListWrapper) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableTachographActivityListWrapper) UnmarshalJSON(src []byte) error {
