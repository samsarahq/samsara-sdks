...
// V1MessageResponse struct for V1MessageResponse
type V1MessageResponse struct {
	...
	Sender V1MessageSender `json:"sender"`
...
// GetSentAtMs returns the SentAtMs field value
...
type NullableV1MessageResponse struct {
	Value        V1MessageResponse
	ExplicitNull bool
}

func (v NullableV1MessageResponse) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1MessageResponse) UnmarshalJSON(src []byte) error {
