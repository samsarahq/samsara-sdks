...
// V1DispatchJobWithoutEta struct for V1DispatchJobWithoutEta
type V1DispatchJobWithoutEta struct {
...
type NullableV1DispatchJobWithoutEta struct {
	Value        V1DispatchJobWithoutEta
	ExplicitNull bool
}

func (v NullableV1DispatchJobWithoutEta) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1DispatchJobWithoutEta) UnmarshalJSON(src []byte) error {
