...
// CarrierProposedAssignmentsApiService CarrierProposedAssignmentsApi service
type CarrierProposedAssignmentsApiService service
...
/*
CreateCarrierProposedAssignment Create an assignment
...
@return apiCreateCarrierProposedAssignmentRequest
*/
func (a *CarrierProposedAssignmentsApiService) CreateCarrierProposedAssignment(ctx _context.Context) apiCreateCarrierProposedAssignmentRequest {
	return apiCreateCarrierProposedAssignmentRequest{
		apiService: a,
		ctx:        ctx,
	}
...
func (r apiCreateCarrierProposedAssignmentRequest) Execute() (CarrierProposedAssignmentResponse, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/fleet/carrier-proposed-assignments"
	...
	// body params
	localVarPostBody = r.carrierProposedAssignment
...
func (r apiDeleteCarrierProposedAssignmentRequest) Execute() (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/fleet/carrier-proposed-assignments/{id}"
