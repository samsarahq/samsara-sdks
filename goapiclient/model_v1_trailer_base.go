...
// V1TrailerBase struct for V1TrailerBase
type V1TrailerBase struct {
	// ID of the trailer
	Id int64 `json:"id"`
...
type NullableV1TrailerBase struct {
	Value        V1TrailerBase
	ExplicitNull bool
}

func (v NullableV1TrailerBase) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1TrailerBase) UnmarshalJSON(src []byte) error {
