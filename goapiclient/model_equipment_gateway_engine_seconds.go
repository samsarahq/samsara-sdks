...
// EquipmentGatewayEngineSeconds Stat point for the cumulative on time of the engine based on readings through the connected aux/digio cable.
type EquipmentGatewayEngineSeconds struct {
...
type NullableEquipmentGatewayEngineSeconds struct {
	Value        EquipmentGatewayEngineSeconds
	ExplicitNull bool
}

func (v NullableEquipmentGatewayEngineSeconds) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableEquipmentGatewayEngineSeconds) UnmarshalJSON(src []byte) error {
