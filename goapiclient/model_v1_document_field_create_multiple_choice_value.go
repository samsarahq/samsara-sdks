...
// V1DocumentFieldCreateMultipleChoiceValue struct for V1DocumentFieldCreateMultipleChoiceValue
type V1DocumentFieldCreateMultipleChoiceValue struct {
	// Whether the multiple choice field is selected or not.
	Selected *bool `json:"selected,omitempty"`
	// The name of the multiple choice field.
...
// GetSelectedOk returns a tuple with the Selected field value if set, zero value otherwise
...
type NullableV1DocumentFieldCreateMultipleChoiceValue struct {
	Value        V1DocumentFieldCreateMultipleChoiceValue
	ExplicitNull bool
}

func (v NullableV1DocumentFieldCreateMultipleChoiceValue) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1DocumentFieldCreateMultipleChoiceValue) UnmarshalJSON(src []byte) error {
