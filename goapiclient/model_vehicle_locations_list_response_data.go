...
// VehicleLocationsListResponseData A vehicle and its list of location events.
type VehicleLocationsListResponseData struct {
	// ID of the vehicle.
	Id string `json:"id"`
...
type NullableVehicleLocationsListResponseData struct {
	Value        VehicleLocationsListResponseData
	ExplicitNull bool
}

func (v NullableVehicleLocationsListResponseData) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableVehicleLocationsListResponseData) UnmarshalJSON(src []byte) error {
