...
// V1Sensor Contains information about a sensor.
...
type NullableV1Sensor struct {
	Value        V1Sensor
	ExplicitNull bool
}

func (v NullableV1Sensor) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1Sensor) UnmarshalJSON(src []byte) error {
