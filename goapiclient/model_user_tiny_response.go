...
// UserTinyResponse A minified user object.
type UserTinyResponse struct {
	// ID of the user.
...
type NullableUserTinyResponse struct {
	Value        UserTinyResponse
	ExplicitNull bool
}

func (v NullableUserTinyResponse) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableUserTinyResponse) UnmarshalJSON(src []byte) error {
