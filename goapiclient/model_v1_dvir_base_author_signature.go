...
// V1DvirBaseAuthorSignature The authors signature for the DVIR.
type V1DvirBaseAuthorSignature struct {
...
type NullableV1DvirBaseAuthorSignature struct {
	Value        V1DvirBaseAuthorSignature
	ExplicitNull bool
}

func (v NullableV1DvirBaseAuthorSignature) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1DvirBaseAuthorSignature) UnmarshalJSON(src []byte) error {
