...
// DvirTrailer struct for DvirTrailer
type DvirTrailer struct {
	// ID of the trailer.
...
type NullableDvirTrailer struct {
	Value        DvirTrailer
	ExplicitNull bool
}

func (v NullableDvirTrailer) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableDvirTrailer) UnmarshalJSON(src []byte) error {
