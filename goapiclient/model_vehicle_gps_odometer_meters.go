...
// VehicleGpsOdometerMeters struct for VehicleGpsOdometerMeters
type VehicleGpsOdometerMeters struct {
	// UTC timestamp in RFC 3339 milliseconds format.
	Time *string `json:"time,omitempty"`
	// Number of meters the vehicle has traveled according to the GPS distance reported by the vehicle gateway and the manually-specified odometer reading.
...
type NullableVehicleGpsOdometerMeters struct {
	Value        VehicleGpsOdometerMeters
	ExplicitNull bool
}

func (v NullableVehicleGpsOdometerMeters) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableVehicleGpsOdometerMeters) UnmarshalJSON(src []byte) error {
