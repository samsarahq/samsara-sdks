...
// EquipmentLocationSnapshotResponse Location for a given piece of equipment.
type EquipmentLocationSnapshotResponse struct {
	// ID of the equipment.
	Id string `json:"id"`
...
type NullableEquipmentLocationSnapshotResponse struct {
	Value        EquipmentLocationSnapshotResponse
	ExplicitNull bool
}

func (v NullableEquipmentLocationSnapshotResponse) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableEquipmentLocationSnapshotResponse) UnmarshalJSON(src []byte) error {
