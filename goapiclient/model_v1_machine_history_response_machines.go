...
// V1MachineHistoryResponseMachines struct for V1MachineHistoryResponseMachines
type V1MachineHistoryResponseMachines struct {
	// Machine ID
	Id *int32 `json:"id,omitempty"`
	// Machine name
	Name *string `json:"name,omitempty"`
	// List of vibration datapoints, with timestamp and vibration measurement for x/y/z axis in mm/s
	Vibrations *[]V1MachineHistoryResponseVibrations `json:"vibrations,omitempty"`
}
...
// GetVibrations returns the Vibrations field value if set, zero value otherwise.
func (o *V1MachineHistoryResponseMachines) GetVibrations() []V1MachineHistoryResponseVibrations {
	if o == nil || o.Vibrations == nil {
		var ret []V1MachineHistoryResponseVibrations
		return ret
	}
	return *o.Vibrations
}

// GetVibrationsOk returns a tuple with the Vibrations field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
type NullableV1MachineHistoryResponseMachines struct {
	Value        V1MachineHistoryResponseMachines
	ExplicitNull bool
}

func (v NullableV1MachineHistoryResponseMachines) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1MachineHistoryResponseMachines) UnmarshalJSON(src []byte) error {
