...
// UpdateDvirRequest Information about resolving a DVIR.
type UpdateDvirRequest struct {
...
type NullableUpdateDvirRequest struct {
	Value        UpdateDvirRequest
	ExplicitNull bool
}

func (v NullableUpdateDvirRequest) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableUpdateDvirRequest) UnmarshalJSON(src []byte) error {
