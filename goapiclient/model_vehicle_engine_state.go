...
// VehicleEngineState struct for VehicleEngineState
type VehicleEngineState struct {
	// UTC timestamp in RFC 3339 milliseconds format.
	Time *string `json:"time,omitempty"`
	// Engine state of the vehicle as read by the vehicle gateway.
...
type NullableVehicleEngineState struct {
	Value        VehicleEngineState
	ExplicitNull bool
}

func (v NullableVehicleEngineState) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableVehicleEngineState) UnmarshalJSON(src []byte) error {
