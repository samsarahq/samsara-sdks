...
// EquipmentEngineState Stat point for the state of the engine based on readings through the connected aux/digio cable.
type EquipmentEngineState struct {
...
type NullableEquipmentEngineState struct {
	Value        EquipmentEngineState
	ExplicitNull bool
}

func (v NullableEquipmentEngineState) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableEquipmentEngineState) UnmarshalJSON(src []byte) error {
