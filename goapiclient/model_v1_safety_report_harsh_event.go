...
// V1SafetyReportHarshEvent List of harsh events
type V1SafetyReportHarshEvent struct {
...
// GetHarshEventType returns the HarshEventType field value if set, zero value otherwise.
func (o *V1SafetyReportHarshEvent) GetHarshEventType() string {
	if o == nil || o.HarshEventType == nil {
		var ret string
		return ret
	}
...
// GetHarshEventTypeOk returns a tuple with the HarshEventType field value if set, zero value otherwise
...
// GetTimestampMsOk returns a tuple with the TimestampMs field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
type NullableV1SafetyReportHarshEvent struct {
	Value        V1SafetyReportHarshEvent
	ExplicitNull bool
}

func (v NullableV1SafetyReportHarshEvent) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1SafetyReportHarshEvent) UnmarshalJSON(src []byte) error {
