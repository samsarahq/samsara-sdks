...
// EquipmentEngineRpm Stat point for the RPM of the engine.
type EquipmentEngineRpm struct {
...
type NullableEquipmentEngineRpm struct {
	Value        EquipmentEngineRpm
	ExplicitNull bool
}

func (v NullableEquipmentEngineRpm) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableEquipmentEngineRpm) UnmarshalJSON(src []byte) error {
