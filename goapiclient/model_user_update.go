...
// UserUpdate The user update arguments
type UserUpdate struct {
	...
	// The roles for this user. Users must have at least a single role to be a part of an organization.
	Roles *[]UserRoleInput `json:"roles,omitempty"`
}
...
// GetAuthTypeOk returns a tuple with the AuthType field value if set, zero value otherwise
