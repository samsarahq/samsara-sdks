...
// DvirPatch Information about resolving a DVIR.
type DvirPatch struct {
...
type NullableDvirPatch struct {
	Value        DvirPatch
	ExplicitNull bool
}

func (v NullableDvirPatch) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableDvirPatch) UnmarshalJSON(src []byte) error {
