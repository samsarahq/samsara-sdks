...
type NullableDvirCreate struct {
	Value        DvirCreate
	ExplicitNull bool
}

func (v NullableDvirCreate) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableDvirCreate) UnmarshalJSON(src []byte) error {
