...
// RouteStopTinyResponse A tiny route stop response object.
type RouteStopTinyResponse struct {
...
type NullableRouteStopTinyResponse struct {
	Value        RouteStopTinyResponse
	ExplicitNull bool
}

func (v NullableRouteStopTinyResponse) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableRouteStopTinyResponse) UnmarshalJSON(src []byte) error {
