...
// V1DispatchJobCreate struct for V1DispatchJobCreate
type V1DispatchJobCreate struct {
...
type NullableV1DispatchJobCreate struct {
	Value        V1DispatchJobCreate
	ExplicitNull bool
}

func (v NullableV1DispatchJobCreate) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableV1DispatchJobCreate) UnmarshalJSON(src []byte) error {
