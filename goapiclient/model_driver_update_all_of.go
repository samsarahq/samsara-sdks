...
// DriverUpdateAllOf struct for DriverUpdateAllOf
type DriverUpdateAllOf struct {
...
type NullableDriverUpdateAllOf struct {
	Value        DriverUpdateAllOf
	ExplicitNull bool
}

func (v NullableDriverUpdateAllOf) MarshalJSON() ([]byte, error) {
	switch {
	case v.ExplicitNull:
...
func (v *NullableDriverUpdateAllOf) UnmarshalJSON(src []byte) error {
