...
**documents** | [**list[V1DispatchJobAllOfDocuments]**](V1DispatchJobAllOfDocuments.md) | Document submissions associated with this job. | [optional] 
...
**job_state** | **str** | The current state of the dispatch job. | 
