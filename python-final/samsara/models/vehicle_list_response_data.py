...
class VehicleListResponseData(object):
    ...
    def __init__(self, aux_input_type1=None, aux_input_type2=None, external_ids=None, harsh_acceleration_setting_type=None, id=None, license_plate=None, make=None, model=None, name=None, notes=None, static_assigned_driver=None, tags=None, vin=None, year=None, local_vars_configuration=None):  # noqa: E501
        """VehicleListResponseData - a model defined in OpenAPI"""  # noqa: E501
    ...
    def aux_input_type1(self):
        """Gets the aux_input_type1 of this VehicleListResponseData.  # noqa: E501
        ...
        :return: The aux_input_type1 of this VehicleListResponseData.  # noqa: E501
        :rtype: str
        """
    ...
    def aux_input_type1(self, aux_input_type1):
        """Sets the aux_input_type1 of this VehicleListResponseData.

        The type of aux input that this vehicle has connected to port 1. Setting to \"none\" will remove the configured aux input.  # noqa: E501

        :param aux_input_type1: The aux_input_type1 of this VehicleListResponseData.  # noqa: E501
        :type: str
        """
    ...
    def aux_input_type2(self):
        """Gets the aux_input_type2 of this VehicleListResponseData.  # noqa: E501
        ...
        :return: The aux_input_type2 of this VehicleListResponseData.  # noqa: E501
        :rtype: str
        """
    ...
    def aux_input_type2(self, aux_input_type2):
        """Sets the aux_input_type2 of this VehicleListResponseData.

        The type of aux input that this vehicle has connected to port 2. Setting to \"none\" will remove the configured aux input.  # noqa: E501

        :param aux_input_type2: The aux_input_type2 of this VehicleListResponseData.  # noqa: E501
        :type: str
        """
        allowed_values = ["none", "emergencyLights", "emergencyAlarm", "stopPaddle", "powerTakeOff", "plow", "sweeper", "salter", "reefer", "door", "boom", "auxiliaryEngine", "generator", "eightWayLights"]  # noqa: E501
    ...
    def external_ids(self):
        """Gets the external_ids of this VehicleListResponseData.  # noqa: E501
        ...
        :return: The external_ids of this VehicleListResponseData.  # noqa: E501
        :rtype: dict(str, str)
        """
    ...
    def external_ids(self, external_ids):
        """Sets the external_ids of this VehicleListResponseData.

        User-defined dictionary of external IDs (key-value pairs). Both the keys and the values of the dictionary are of type string and must be alphanumeric. Each organization can have at most 10 unique external ID keys. To delete an external ID, set its value to null or the empty string (`\"\"`). An external ID can be used as a path parameter to retrieve or update that resource.  # noqa: E501

        :param external_ids: The external_ids of this VehicleListResponseData.  # noqa: E501
        :type: dict(str, str)
        """
    ...
    def harsh_acceleration_setting_type(self):
        """Gets the harsh_acceleration_setting_type of this VehicleListResponseData.  # noqa: E501
        ...
        :return: The harsh_acceleration_setting_type of this VehicleListResponseData.  # noqa: E501
        :rtype: str
        """
    ...
    def harsh_acceleration_setting_type(self, harsh_acceleration_setting_type):
        """Sets the harsh_acceleration_setting_type of this VehicleListResponseData.

        Enumeration of the harsh acceleration setting types. This setting influences the acceleration sensitivity from which a harsh event is triggered. If set to `off`, then no acceleration based harsh events are triggered for the vehicle.  # noqa: E501

        :param harsh_acceleration_setting_type: The harsh_acceleration_setting_type of this VehicleListResponseData.  # noqa: E501
        :type: str
        """
    ...
    @property
    def id(self):
        """Gets the id of this VehicleListResponseData.  # noqa: E501

        Unique Samsara ID for the vehicle.  # noqa: E501

        :return: The id of this VehicleListResponseData.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this VehicleListResponseData.

        Unique Samsara ID for the vehicle.  # noqa: E501

        :param id: The id of this VehicleListResponseData.  # noqa: E501
        :type: str
        """
    ...
    def license_plate(self):
        """Gets the license_plate of this VehicleListResponseData.  # noqa: E501

        The license plate of this vehicle.  # noqa: E501

        :return: The license_plate of this VehicleListResponseData.  # noqa: E501
        :rtype: str
        """
    ...
    def license_plate(self, license_plate):
        """Sets the license_plate of this VehicleListResponseData.

        The license plate of this vehicle.  # noqa: E501

        :param license_plate: The license_plate of this VehicleListResponseData.  # noqa: E501
        :type: str
        """
    ...
    @property
    def make(self):
        """Gets the make of this VehicleListResponseData.  # noqa: E501

        Vehicle's manufacturing make.  # noqa: E501

        :return: The make of this VehicleListResponseData.  # noqa: E501
        :rtype: str
        """
        return self._make
    ...
    @make.setter
    def make(self, make):
        """Sets the make of this VehicleListResponseData.

        Vehicle's manufacturing make.  # noqa: E501

        :param make: The make of this VehicleListResponseData.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def model(self):
        """Gets the model of this VehicleListResponseData.  # noqa: E501

        Vehicle's manufacturing model.  # noqa: E501

        :return: The model of this VehicleListResponseData.  # noqa: E501
        :rtype: str
        """
        return self._model
    ...
    def model(self, model):
        """Sets the model of this VehicleListResponseData.

        Vehicle's manufacturing model.  # noqa: E501

        :param model: The model of this VehicleListResponseData.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def name(self):
        """Gets the name of this VehicleListResponseData.  # noqa: E501

        Name of the vehicle.  # noqa: E501

        :return: The name of this VehicleListResponseData.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this VehicleListResponseData.

        Name of the vehicle.  # noqa: E501

        :param name: The name of this VehicleListResponseData.  # noqa: E501
        :type: str
        """
    ...
    @property
    def notes(self):
        """Gets the notes of this VehicleListResponseData.  # noqa: E501

        Notes about a vehicle. Samsara supports a maximum of 255 chars.  # noqa: E501

        :return: The notes of this VehicleListResponseData.  # noqa: E501
        :rtype: str
        """
        return self._notes
    ...
    def notes(self, notes):
        """Sets the notes of this VehicleListResponseData.

        Notes about a vehicle. Samsara supports a maximum of 255 chars.  # noqa: E501

        :param notes: The notes of this VehicleListResponseData.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def static_assigned_driver(self):
        """Gets the static_assigned_driver of this VehicleListResponseData.  # noqa: E501


        :return: The static_assigned_driver of this VehicleListResponseData.  # noqa: E501
    ...
    def static_assigned_driver(self, static_assigned_driver):
        """Sets the static_assigned_driver of this VehicleListResponseData.


        :param static_assigned_driver: The static_assigned_driver of this VehicleListResponseData.  # noqa: E501
    ...
    @property
    def tags(self):
        """Gets the tags of this VehicleListResponseData.  # noqa: E501

        An array of all tag mini-objects that are associated with the given vehicle.  # noqa: E501

        :return: The tags of this VehicleListResponseData.  # noqa: E501
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this VehicleListResponseData.

        An array of all tag mini-objects that are associated with the given vehicle.  # noqa: E501

        :param tags: The tags of this VehicleListResponseData.  # noqa: E501
    ...
    @property
    def vin(self):
        """Gets the vin of this VehicleListResponseData.  # noqa: E501

        A vehicle identification number.  # noqa: E501

        :return: The vin of this VehicleListResponseData.  # noqa: E501
        :rtype: str
        """
        return self._vin
    ...
    @vin.setter
    def vin(self, vin):
        """Sets the vin of this VehicleListResponseData.

        A vehicle identification number.  # noqa: E501

        :param vin: The vin of this VehicleListResponseData.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def year(self):
        """Gets the year of this VehicleListResponseData.  # noqa: E501

        Vehicle's manufacturing year.  # noqa: E501

        :return: The year of this VehicleListResponseData.  # noqa: E501
        :rtype: str
        """
        return self._year
    ...
    @year.setter
    def year(self, year):
        """Sets the year of this VehicleListResponseData.

        Vehicle's manufacturing year.  # noqa: E501

        :param year: The year of this VehicleListResponseData.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VehicleListResponseData):
            return False
