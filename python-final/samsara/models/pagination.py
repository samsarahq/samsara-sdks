...
class Pagination(object):
    ...
    def end_cursor(self):
        ...
        Cursor representing the last element in the response. Feed this value into an `after` parameter to get the next page of results. This will be an empty string if `hasNextPage` is `false`.  # noqa: E501
    ...
    def has_next_page(self):
        ...
        Indicates whether there are more pages of results for this query.  # noqa: E501
