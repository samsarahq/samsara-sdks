...
class V1DispatchRouteCreateAllOf1(object):
    ...
    def __init__(self, driver_id=None, name=None, notes=None, scheduled_end_ms=None, scheduled_meters=None, scheduled_start_ms=None, start_location_address=None, start_location_address_id=None, start_location_lat=None, start_location_lng=None, start_location_name=None, trailer_id=None, vehicle_id=None, local_vars_configuration=None):  # noqa: E501
        """V1DispatchRouteCreateAllOf1 - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def driver_id(self):
        """Gets the driver_id of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        ...
        :return: The driver_id of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        :rtype: int
        """
    ...
    def driver_id(self, driver_id):
        """Sets the driver_id of this V1DispatchRouteCreateAllOf1.

        ID of the driver assigned to the dispatch route. Note that driver_id and vehicle_id are mutually exclusive. If neither is specified, then the route is unassigned.  # noqa: E501

        :param driver_id: The driver_id of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        :type: int
        """
    ...
    @property
    def name(self):
        """Gets the name of this V1DispatchRouteCreateAllOf1.  # noqa: E501

        Descriptive name of this route.  # noqa: E501

        :return: The name of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this V1DispatchRouteCreateAllOf1.

        Descriptive name of this route.  # noqa: E501

        :param name: The name of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        :type: str
        """
    ...
    @property
    def notes(self):
        """Gets the notes of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        ...
        :return: The notes of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        :rtype: str
        """
        return self._notes
    ...
    def notes(self, notes):
        """Sets the notes of this V1DispatchRouteCreateAllOf1.

        Notes regarding the details of this route; maximum of 2000 characters; newline characters ('\\n')can be used for formatting.  # noqa: E501

        :param notes: The notes of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        :type: str
        """
    ...
    def scheduled_end_ms(self):
        """Gets the scheduled_end_ms of this V1DispatchRouteCreateAllOf1.  # noqa: E501

        The time in Unix epoch milliseconds that the last job in the route is scheduled to end.  # noqa: E501

        :return: The scheduled_end_ms of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        :rtype: int
        """
    ...
    def scheduled_end_ms(self, scheduled_end_ms):
        """Sets the scheduled_end_ms of this V1DispatchRouteCreateAllOf1.

        The time in Unix epoch milliseconds that the last job in the route is scheduled to end.  # noqa: E501

        :param scheduled_end_ms: The scheduled_end_ms of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        :type: int
        """
    ...
    def scheduled_meters(self):
        """Gets the scheduled_meters of this V1DispatchRouteCreateAllOf1.  # noqa: E501

        The distance expected to be traveled for this route in meters.  # noqa: E501

        :return: The scheduled_meters of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        :rtype: int
        """
    ...
    def scheduled_meters(self, scheduled_meters):
        """Sets the scheduled_meters of this V1DispatchRouteCreateAllOf1.

        The distance expected to be traveled for this route in meters.  # noqa: E501

        :param scheduled_meters: The scheduled_meters of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        :type: int
        """
    ...
    def scheduled_start_ms(self):
        """Gets the scheduled_start_ms of this V1DispatchRouteCreateAllOf1.  # noqa: E501

        The time in Unix epoch milliseconds that the route is scheduled to start.  # noqa: E501

        :return: The scheduled_start_ms of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        :rtype: int
        """
    ...
    def scheduled_start_ms(self, scheduled_start_ms):
        """Sets the scheduled_start_ms of this V1DispatchRouteCreateAllOf1.

        The time in Unix epoch milliseconds that the route is scheduled to start.  # noqa: E501

        :param scheduled_start_ms: The scheduled_start_ms of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        :type: int
        """
    ...
    def start_location_address(self):
        """Gets the start_location_address of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        ...
        :return: The start_location_address of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        :rtype: str
        """
    ...
    def start_location_address(self, start_location_address):
        """Sets the start_location_address of this V1DispatchRouteCreateAllOf1.

        The address of the route's starting location, as it would be recognized if provided to maps.google.com. Optional if a valid start location address ID is provided.  # noqa: E501

        :param start_location_address: The start_location_address of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        :type: str
        """
    ...
    def start_location_address_id(self):
        """Gets the start_location_address_id of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        ...
        :return: The start_location_address_id of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        :rtype: int
        """
    ...
    def start_location_address_id(self, start_location_address_id):
        """Sets the start_location_address_id of this V1DispatchRouteCreateAllOf1.

        ID of the start location associated with an address book entry. Optional if valid values are provided for start location address and latitude/longitude. If a valid start location address ID is provided, address/latitude/longitude will be used from the address book entry. Name of the address book entry will only be used if the start location name is not provided.  # noqa: E501

        :param start_location_address_id: The start_location_address_id of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        :type: int
        """
    ...
    def start_location_lat(self):
        """Gets the start_location_lat of this V1DispatchRouteCreateAllOf1.  # noqa: E501

        Latitude of the start location in decimal degrees. Optional if a valid start location address ID is provided.  # noqa: E501

        :return: The start_location_lat of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        :rtype: float
        """
    ...
    def start_location_lat(self, start_location_lat):
        """Sets the start_location_lat of this V1DispatchRouteCreateAllOf1.

        Latitude of the start location in decimal degrees. Optional if a valid start location address ID is provided.  # noqa: E501

        :param start_location_lat: The start_location_lat of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        :type: float
        """
    ...
    def start_location_lng(self):
        """Gets the start_location_lng of this V1DispatchRouteCreateAllOf1.  # noqa: E501

        Longitude of the start location in decimal degrees. Optional if a valid start location address ID is provided.  # noqa: E501

        :return: The start_location_lng of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        :rtype: float
        """
    ...
    def start_location_lng(self, start_location_lng):
        """Sets the start_location_lng of this V1DispatchRouteCreateAllOf1.

        Longitude of the start location in decimal degrees. Optional if a valid start location address ID is provided.  # noqa: E501

        :param start_location_lng: The start_location_lng of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        :type: float
        """
    ...
    def start_location_name(self):
        """Gets the start_location_name of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        ...
        :return: The start_location_name of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        :rtype: str
        """
    ...
    def start_location_name(self, start_location_name):
        """Sets the start_location_name of this V1DispatchRouteCreateAllOf1.

        The name of the route's starting location. If provided, it will take precedence over the name of the address book entry.  # noqa: E501

        :param start_location_name: The start_location_name of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        :type: str
        """
    ...
    @property
    def trailer_id(self):
        """Gets the trailer_id of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        ...
        :return: The trailer_id of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        :rtype: int
        """
    ...
    def trailer_id(self, trailer_id):
        """Sets the trailer_id of this V1DispatchRouteCreateAllOf1.

        ID of the trailer assigned to the dispatch route. Note that trailers can only be assigned to routes that have a Vehicle or Driver assigned to them.  # noqa: E501

        :param trailer_id: The trailer_id of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        :type: int
        """
    ...
    @property
    def vehicle_id(self):
        """Gets the vehicle_id of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        ...
        :return: The vehicle_id of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        :rtype: int
        """
    ...
    def vehicle_id(self, vehicle_id):
        """Sets the vehicle_id of this V1DispatchRouteCreateAllOf1.

        ID of the vehicle assigned to the dispatch route. Note that vehicle_id and driver_id are mutually exclusive. If neither is specified, then the route is unassigned.  # noqa: E501

        :param vehicle_id: The vehicle_id of this V1DispatchRouteCreateAllOf1.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1DispatchRouteCreateAllOf1):
            return False
