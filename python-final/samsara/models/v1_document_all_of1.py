...
class V1DocumentAllOf1(object):
    ...
    def __init__(self, dispatch_job_id=None, notes=None, state='Required', local_vars_configuration=None):  # noqa: E501
        """V1DocumentAllOf1 - a model defined in OpenAPI"""  # noqa: E501
    ...
    def dispatch_job_id(self):
        """Gets the dispatch_job_id of this V1DocumentAllOf1.  # noqa: E501

        ID of the Samsara dispatch job for which the document is submitted  # noqa: E501

        :return: The dispatch_job_id of this V1DocumentAllOf1.  # noqa: E501
        :rtype: int
        """
    ...
    def dispatch_job_id(self, dispatch_job_id):
        """Sets the dispatch_job_id of this V1DocumentAllOf1.

        ID of the Samsara dispatch job for which the document is submitted  # noqa: E501

        :param dispatch_job_id: The dispatch_job_id of this V1DocumentAllOf1.  # noqa: E501
        :type: int
        """
    ...
    @property
    def notes(self):
        """Gets the notes of this V1DocumentAllOf1.  # noqa: E501

        Notes submitted with this document.  # noqa: E501

        :return: The notes of this V1DocumentAllOf1.  # noqa: E501
        :rtype: str
        """
        return self._notes
    ...
    def notes(self, notes):
        """Sets the notes of this V1DocumentAllOf1.

        Notes submitted with this document.  # noqa: E501

        :param notes: The notes of this V1DocumentAllOf1.  # noqa: E501
        :type: str
        """
    ...
    @property
    def state(self):
        """Gets the state of this V1DocumentAllOf1.  # noqa: E501
        ...
        :return: The state of this V1DocumentAllOf1.  # noqa: E501
        :rtype: str
        """
        return self._state
    ...
    def state(self, state):
        """Sets the state of this V1DocumentAllOf1.

        The condition of the document created for the driver. Can be either `Required` or `Submitted`, if no value is specified, `state` defaults to `Required`. `Required` documents are pre-populated documents for the Driver to fill out in the Driver App.  # noqa: E501

        :param state: The state of this V1DocumentAllOf1.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1DocumentAllOf1):
            return False
