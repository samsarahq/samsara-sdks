...
class VehicleListResponsePagination(object):
    ...
    def __init__(self, end_cursor=None, has_next_page=None, local_vars_configuration=None):  # noqa: E501
        """VehicleListResponsePagination - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def end_cursor(self):
        """Gets the end_cursor of this VehicleListResponsePagination.  # noqa: E501
        ...
        :return: The end_cursor of this VehicleListResponsePagination.  # noqa: E501
        :rtype: str
        """
    ...
    def end_cursor(self, end_cursor):
        """Sets the end_cursor of this VehicleListResponsePagination.

        Cursor identifier representing the last element in the response. This value should be used in conjunction with a subsequent request's 'after' query parameter. This may be an empty string if there are no more pages left to view.  # noqa: E501

        :param end_cursor: The end_cursor of this VehicleListResponsePagination.  # noqa: E501
        :type: str
        """
    ...
    def has_next_page(self):
        """Gets the has_next_page of this VehicleListResponsePagination.  # noqa: E501

        True if there are more pages of results immediately available after this endCursor.  # noqa: E501

        :return: The has_next_page of this VehicleListResponsePagination.  # noqa: E501
        :rtype: bool
        """
    ...
    def has_next_page(self, has_next_page):
        """Sets the has_next_page of this VehicleListResponsePagination.

        True if there are more pages of results immediately available after this endCursor.  # noqa: E501

        :param has_next_page: The has_next_page of this VehicleListResponsePagination.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VehicleListResponsePagination):
            return False
