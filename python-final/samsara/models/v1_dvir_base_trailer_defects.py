...
class V1DvirBaseTrailerDefects(object):
    ...
    def __init__(self, comment=None, defect_type=None, id=None, resolved=None, resolved_at=None, resolved_by_driver_id=None, resolved_by_mechanic_id=None, local_vars_configuration=None):  # noqa: E501
        """V1DvirBaseTrailerDefects - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def comment(self):
        """Gets the comment of this V1DvirBaseTrailerDefects.  # noqa: E501

        The comment describing the type of DVIR defect.  # noqa: E501

        :return: The comment of this V1DvirBaseTrailerDefects.  # noqa: E501
        :rtype: str
        """
    ...
    def comment(self, comment):
        """Sets the comment of this V1DvirBaseTrailerDefects.

        The comment describing the type of DVIR defect.  # noqa: E501

        :param comment: The comment of this V1DvirBaseTrailerDefects.  # noqa: E501
        :type: str
        """
    ...
    def defect_type(self):
        """Gets the defect_type of this V1DvirBaseTrailerDefects.  # noqa: E501
        ...
        :return: The defect_type of this V1DvirBaseTrailerDefects.  # noqa: E501
        :rtype: str
        """
    ...
    def defect_type(self, defect_type):
        """Sets the defect_type of this V1DvirBaseTrailerDefects.

        The type of DVIR defect. Possible values: [`AIR_COMPRESSOR`, `AIR_CONDITIONER`, `AIR_LINES`, `BATTERY`, `BELTS_HOSES`, `BRAKE_ACCESSORIES`, `BRAKE_CHECK`, `BRAKE_CONNECTIONS`, `BRAKES`, `CLUTCH`, `COUPLING_DEVICES`, `DEFROSTER_HEATER`, `DOORS`, `DRIVE_LINE`, `EMERGENCY_DOOR_AND_BUZZER`, `ENGINE`, `ENTRANCE_STEPS`, `EXHAUST`, `FIFTH_WHEEL`, `FIRST_AID_KIT`, `FLUID_LEVELS`, `FRAME_ASSEMBLY`, `FRONT_AXLE`, `FUEL_TANKS`, `HORN`, `INTERIOR_AND_FLOOR`, `LANDING_GEAR`, `LIGHTS`, `MIRRORS`, `MUFFLER`, `OIL_PRESSURE`, `OTHER`, `RADIATOR`, `REAR_END`, `REFLECTORS`, `ROOF`, `SAFETY_EQUIPMENT`, `STARTER`, `STEERING`, `STOP_ARM_CONTROL`, `STOP_ARM`, `SUSPENSION`, `TIRE_CHAINS`, `TIRES`, `TRANSMISSION`, `TRIP_RECORDER`, `WHEELS_RIMS`, `WINDOWS`, `WINDSHIELD_WIPERS`, `UNSET`]  # noqa: E501

        :param defect_type: The defect_type of this V1DvirBaseTrailerDefects.  # noqa: E501
        :type: str
        """
    ...
    @property
    def id(self):
        """Gets the id of this V1DvirBaseTrailerDefects.  # noqa: E501

        The id of this defect.  # noqa: E501

        :return: The id of this V1DvirBaseTrailerDefects.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this V1DvirBaseTrailerDefects.

        The id of this defect.  # noqa: E501

        :param id: The id of this V1DvirBaseTrailerDefects.  # noqa: E501
        :type: int
        """
    ...
    @property
    def resolved(self):
        """Gets the resolved of this V1DvirBaseTrailerDefects.  # noqa: E501

        Signifies if this defect is resolved.  # noqa: E501

        :return: The resolved of this V1DvirBaseTrailerDefects.  # noqa: E501
        :rtype: bool
        """
    ...
    def resolved(self, resolved):
        """Sets the resolved of this V1DvirBaseTrailerDefects.

        Signifies if this defect is resolved.  # noqa: E501

        :param resolved: The resolved of this V1DvirBaseTrailerDefects.  # noqa: E501
        :type: bool
        """
    ...
    def resolved_at(self):
        """Gets the resolved_at of this V1DvirBaseTrailerDefects.  # noqa: E501

        Timestamp when this defect was resolved, in UNIX milliseconds.  Will not be returned if the defect is unresolved.  # noqa: E501

        :return: The resolved_at of this V1DvirBaseTrailerDefects.  # noqa: E501
        :rtype: int
        """
    ...
    def resolved_at(self, resolved_at):
        """Sets the resolved_at of this V1DvirBaseTrailerDefects.

        Timestamp when this defect was resolved, in UNIX milliseconds.  Will not be returned if the defect is unresolved.  # noqa: E501

        :param resolved_at: The resolved_at of this V1DvirBaseTrailerDefects.  # noqa: E501
        :type: int
        """
    ...
    def resolved_by_driver_id(self):
        """Gets the resolved_by_driver_id of this V1DvirBaseTrailerDefects.  # noqa: E501
        ...
        :return: The resolved_by_driver_id of this V1DvirBaseTrailerDefects.  # noqa: E501
        :rtype: int
        """
    ...
    def resolved_by_driver_id(self, resolved_by_driver_id):
        """Sets the resolved_by_driver_id of this V1DvirBaseTrailerDefects.

        ID of the driver who resolved this defect. Will not be returned if the defect is unresolved or resolvedByMechanicId is returned.  # noqa: E501

        :param resolved_by_driver_id: The resolved_by_driver_id of this V1DvirBaseTrailerDefects.  # noqa: E501
        :type: int
        """
    ...
    def resolved_by_mechanic_id(self):
        """Gets the resolved_by_mechanic_id of this V1DvirBaseTrailerDefects.  # noqa: E501
        ...
        :return: The resolved_by_mechanic_id of this V1DvirBaseTrailerDefects.  # noqa: E501
        :rtype: int
        """
    ...
    def resolved_by_mechanic_id(self, resolved_by_mechanic_id):
        """Sets the resolved_by_mechanic_id of this V1DvirBaseTrailerDefects.

        ID of the mechanic who resolved this defect. Will not be returned if the defect is unresolved or resolvedByDriverId is returned.  # noqa: E501

        :param resolved_by_mechanic_id: The resolved_by_mechanic_id of this V1DvirBaseTrailerDefects.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1DvirBaseTrailerDefects):
            return False
