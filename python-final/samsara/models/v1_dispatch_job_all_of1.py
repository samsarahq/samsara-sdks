...
class V1DispatchJobAllOf1(object):
    ...
    def __init__(self, destination_address=None, destination_address_id=None, destination_lat=None, destination_lng=None, destination_name=None, notes=None, scheduled_arrival_time_ms=None, scheduled_departure_time_ms=None, local_vars_configuration=None):  # noqa: E501
        """V1DispatchJobAllOf1 - a model defined in OpenAPI"""  # noqa: E501
    ...
    def destination_address(self):
        """Gets the destination_address of this V1DispatchJobAllOf1.  # noqa: E501
        ...
        :return: The destination_address of this V1DispatchJobAllOf1.  # noqa: E501
        :rtype: str
        """
    ...
    def destination_address(self, destination_address):
        """Sets the destination_address of this V1DispatchJobAllOf1.

        The address of the job destination, as it would be recognized if provided to maps.google.com. Optional if a valid destination address ID is provided.  # noqa: E501

        :param destination_address: The destination_address of this V1DispatchJobAllOf1.  # noqa: E501
        :type: str
        """
    ...
    def destination_address_id(self):
        """Gets the destination_address_id of this V1DispatchJobAllOf1.  # noqa: E501
        ...
        :return: The destination_address_id of this V1DispatchJobAllOf1.  # noqa: E501
        :rtype: int
        """
    ...
    def destination_address_id(self, destination_address_id):
        """Sets the destination_address_id of this V1DispatchJobAllOf1.

        ID of the job destination associated with an address book entry. Optional if valid values are provided for destination address and latitude/longitude. If a valid destination address ID is provided, address/latitude/longitude will be used from the address book entry. Name of the address book entry will only be used if the destination name is not provided.  # noqa: E501

        :param destination_address_id: The destination_address_id of this V1DispatchJobAllOf1.  # noqa: E501
        :type: int
        """
    ...
    def destination_lat(self):
        """Gets the destination_lat of this V1DispatchJobAllOf1.  # noqa: E501

        Latitude of the destination in decimal degrees. Optional if a valid destination address ID is provided.  # noqa: E501

        :return: The destination_lat of this V1DispatchJobAllOf1.  # noqa: E501
        :rtype: float
        """
    ...
    def destination_lat(self, destination_lat):
        """Sets the destination_lat of this V1DispatchJobAllOf1.

        Latitude of the destination in decimal degrees. Optional if a valid destination address ID is provided.  # noqa: E501

        :param destination_lat: The destination_lat of this V1DispatchJobAllOf1.  # noqa: E501
        :type: float
        """
    ...
    def destination_lng(self):
        """Gets the destination_lng of this V1DispatchJobAllOf1.  # noqa: E501

        Longitude of the destination in decimal degrees. Optional if a valid destination address ID is provided.  # noqa: E501

        :return: The destination_lng of this V1DispatchJobAllOf1.  # noqa: E501
        :rtype: float
        """
    ...
    def destination_lng(self, destination_lng):
        """Sets the destination_lng of this V1DispatchJobAllOf1.

        Longitude of the destination in decimal degrees. Optional if a valid destination address ID is provided.  # noqa: E501

        :param destination_lng: The destination_lng of this V1DispatchJobAllOf1.  # noqa: E501
        :type: float
        """
    ...
    def destination_name(self):
        """Gets the destination_name of this V1DispatchJobAllOf1.  # noqa: E501

        The name of the job destination. If provided, it will take precedence over the name of the address book entry.  # noqa: E501

        :return: The destination_name of this V1DispatchJobAllOf1.  # noqa: E501
        :rtype: str
        """
    ...
    def destination_name(self, destination_name):
        """Sets the destination_name of this V1DispatchJobAllOf1.

        The name of the job destination. If provided, it will take precedence over the name of the address book entry.  # noqa: E501

        :param destination_name: The destination_name of this V1DispatchJobAllOf1.  # noqa: E501
        :type: str
        """
    ...
    @property
    def notes(self):
        """Gets the notes of this V1DispatchJobAllOf1.  # noqa: E501
        ...
        :return: The notes of this V1DispatchJobAllOf1.  # noqa: E501
        :rtype: str
        """
        return self._notes
    ...
    def notes(self, notes):
        """Sets the notes of this V1DispatchJobAllOf1.

        Notes regarding the details of this job, maximum of 2000 characters; newline characters ('\\n')can be used for formatting.  # noqa: E501

        :param notes: The notes of this V1DispatchJobAllOf1.  # noqa: E501
        :type: str
        """
    ...
    def scheduled_arrival_time_ms(self):
        """Gets the scheduled_arrival_time_ms of this V1DispatchJobAllOf1.  # noqa: E501

        The time at which the assigned driver is scheduled to arrive at the job destination.  # noqa: E501

        :return: The scheduled_arrival_time_ms of this V1DispatchJobAllOf1.  # noqa: E501
        :rtype: int
        """
    ...
    def scheduled_arrival_time_ms(self, scheduled_arrival_time_ms):
        """Sets the scheduled_arrival_time_ms of this V1DispatchJobAllOf1.

        The time at which the assigned driver is scheduled to arrive at the job destination.  # noqa: E501

        :param scheduled_arrival_time_ms: The scheduled_arrival_time_ms of this V1DispatchJobAllOf1.  # noqa: E501
        :type: int
        """
    ...
    def scheduled_departure_time_ms(self):
        """Gets the scheduled_departure_time_ms of this V1DispatchJobAllOf1.  # noqa: E501

        The time at which the assigned driver is scheduled to depart from the job destination.  # noqa: E501

        :return: The scheduled_departure_time_ms of this V1DispatchJobAllOf1.  # noqa: E501
        :rtype: int
        """
    ...
    def scheduled_departure_time_ms(self, scheduled_departure_time_ms):
        """Sets the scheduled_departure_time_ms of this V1DispatchJobAllOf1.

        The time at which the assigned driver is scheduled to depart from the job destination.  # noqa: E501

        :param scheduled_departure_time_ms: The scheduled_departure_time_ms of this V1DispatchJobAllOf1.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1DispatchJobAllOf1):
            return False
