...
class AddressRequestCoreAllOf1(object):
    ...
    def __init__(self, address_types=None, formatted_address=None, name=None, notes=None, local_vars_configuration=None):  # noqa: E501
        """AddressRequestCoreAllOf1 - a model defined in OpenAPI"""  # noqa: E501
    ...
    def address_types(self):
        """Gets the address_types of this AddressRequestCoreAllOf1.  # noqa: E501

        Reporting location type associated with the address (used for ELD reporting purposes).  # noqa: E501

        :return: The address_types of this AddressRequestCoreAllOf1.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def address_types(self, address_types):
        """Sets the address_types of this AddressRequestCoreAllOf1.

        Reporting location type associated with the address (used for ELD reporting purposes).  # noqa: E501

        :param address_types: The address_types of this AddressRequestCoreAllOf1.  # noqa: E501
        :type: list[str]
        """
    ...
    def formatted_address(self):
        """Gets the formatted_address of this AddressRequestCoreAllOf1.  # noqa: E501

        The full street address for this address/geofence, as it might be recognized by Google Maps.  # noqa: E501

        :return: The formatted_address of this AddressRequestCoreAllOf1.  # noqa: E501
        :rtype: str
        """
    ...
    def formatted_address(self, formatted_address):
        """Sets the formatted_address of this AddressRequestCoreAllOf1.

        The full street address for this address/geofence, as it might be recognized by Google Maps.  # noqa: E501

        :param formatted_address: The formatted_address of this AddressRequestCoreAllOf1.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def name(self):
        """Gets the name of this AddressRequestCoreAllOf1.  # noqa: E501

        Name of the address.  # noqa: E501

        :return: The name of this AddressRequestCoreAllOf1.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this AddressRequestCoreAllOf1.

        Name of the address.  # noqa: E501

        :param name: The name of this AddressRequestCoreAllOf1.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def notes(self):
        """Gets the notes of this AddressRequestCoreAllOf1.  # noqa: E501

        Notes about the address.  # noqa: E501

        :return: The notes of this AddressRequestCoreAllOf1.  # noqa: E501
        :rtype: str
        """
        return self._notes
    ...
    def notes(self, notes):
        """Sets the notes of this AddressRequestCoreAllOf1.

        Notes about the address.  # noqa: E501

        :param notes: The notes of this AddressRequestCoreAllOf1.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddressRequestCoreAllOf1):
            return False
