...
class VehicleStatsSnapshotResponse(object):
    ...
    def __init__(self, engine_state=None, fuel_percent=None, gps_odometer_meters=None, obd_engine_seconds=None, obd_odometer_meters=None, id=None, name=None, local_vars_configuration=None):  # noqa: E501
